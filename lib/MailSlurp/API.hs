...
type MailSlurpAPI
    ...
    :<|> "webhooks" :> "results" :> QueryParam "before" UTCTime :> QueryParam "page" Int :> QueryParam "searchFilter" Text :> QueryParam "since" UTCTime :> QueryParam "size" Int :> QueryParam "sort" Text :> Verb 'GET 200 '[JSON] PageWebhookResult -- 'getAllWebhookResults' route
    ...
    :<|> "webhooks" :> Capture "webhookId" UUID :> "results" :> QueryParam "before" UTCTime :> QueryParam "page" Int :> QueryParam "searchFilter" Text :> QueryParam "since" UTCTime :> QueryParam "size" Int :> QueryParam "sort" Text :> Verb 'GET 200 '[JSON] PageWebhookResult -- 'getWebhookResults' route
...
data MailSlurpBackend m = MailSlurpBackend
  ...
  , getAllWebhookResults :: Maybe UTCTime -> Maybe Int -> Maybe Text -> Maybe UTCTime -> Maybe Int -> Maybe Text -> m PageWebhookResult{- ^  -}
  ...
  , getWebhookResults :: UUID -> Maybe UTCTime -> Maybe Int -> Maybe Text -> Maybe UTCTime -> Maybe Int -> Maybe Text -> m PageWebhookResult{- ^  -}
