...
type MailSlurpAPI
    ...
    :<|> "webhooks" :> "results" :> QueryParam "page" Int :> QueryParam "size" Int :> QueryParam "sort" Text :> Verb 'GET 200 '[JSON] PageWebhookResult -- 'getAllWebhookResults' route
    ...
    :<|> "webhooks" :> Capture "webhookId" UUID :> "results" :> QueryParam "page" Int :> QueryParam "size" Int :> QueryParam "sort" Text :> Verb 'GET 200 '[JSON] PageWebhookResult -- 'getWebhookResults' route
...
data MailSlurpBackend m = MailSlurpBackend
  ...
  , getAllWebhookResults :: Maybe Int -> Maybe Int -> Maybe Text -> m PageWebhookResult{- ^  -}
  ...
  , getWebhookResults :: UUID -> Maybe Int -> Maybe Int -> Maybe Text -> m PageWebhookResult{- ^  -}
