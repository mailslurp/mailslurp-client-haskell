...
type MailSlurpAPI
    =    "ai" :> "structured-content" :> "attachment" :> ReqBody '[JSON] GenerateStructuredContentAttachmentOptions :> Verb 'POST 200 '[JSON] StructuredContentResult -- 'generateStructuredContentFromAttachment' route
    :<|> "ai" :> "structured-content" :> "email" :> ReqBody '[JSON] GenerateStructuredContentEmailOptions :> Verb 'POST 200 '[JSON] StructuredContentResult -- 'generateStructuredContentFromEmail' route
...
data MailSlurpBackend m = MailSlurpBackend
  { generateStructuredContentFromAttachment :: GenerateStructuredContentAttachmentOptions -> m StructuredContentResult{- ^ Use output schemas to extract data from an attachment using AI -}
  , generateStructuredContentFromEmail :: GenerateStructuredContentEmailOptions -> m StructuredContentResult{- ^ Use output schemas to extract data from an email using AI -}
