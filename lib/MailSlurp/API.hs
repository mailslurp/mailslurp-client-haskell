...
type MailSlurpAPI
    =    "ai" :> "transformer" :> QueryParam "page" Int :> QueryParam "size" Int :> QueryParam "sort" Text :> QueryParam "options" AITranformCreateOptions :> Verb 'GET 200 '[JSON] PageAITransformProjection -- 'createTransformer' route
    :<|> "ai" :> "transformer" :> ReqBody '[JSON] AITranformCreateOptions :> Verb 'POST 200 '[JSON] AITransformDto -- 'createTransformer1' route
    ...
    :<|> "ai" :> "transformer" :> "results" :> QueryParam "aiTransformId" UUID :> QueryParam "aiTransformMappingId" UUID :> QueryParam "entityId" UUID :> QueryParam "entityType" Text :> QueryParam "page" Int :> QueryParam "size" Int :> QueryParam "sort" Text :> Verb 'GET 200 '[JSON] PageAITransformResultProjection -- 'getTransformerResults' route
    ...
    :<|> "attachments" :> QueryParam "page" Int :> QueryParam "size" Int :> QueryParam "sort" Text :> QueryParam "fileNameFilter" Text :> QueryParam "since" UTCTime :> QueryParam "before" UTCTime :> QueryParam "inboxId" UUID :> QueryParam "emailId" UUID :> QueryParam "sentEmailId" UUID :> Verb 'GET 200 '[JSON] PageAttachmentEntity -- 'getAttachments' route
    ...
    :<|> "mfa" :> "totp" :> "device" :> "custom" :> ReqBody '[JSON] CreateTotpDeviceOtpAuthUrlOptions :> Verb 'POST 200 '[JSON] TotpDeviceDto -- 'createTotpDeviceForCustom' route
    ...
    :<|> "mfa" :> "totp" :> "device" :> Capture "id" UUID :> "code" :> QueryParam "at" UTCTime :> Verb 'GET 200 '[JSON] TotpDeviceCodeDto -- 'getTotpDeviceCode' route
    ...
    :<|> "oauth-connection" :> QueryParam "redirectBase" Text :> QueryParam "oAuthConnectionType" Text :> QueryParam "emailAddress" Text :> Verb 'POST 200 '[JSON] CreateOAuthConnectionResult -- 'createOAuthConnection' route
    :<|> "oauth-connection" :> "oauth-exchange" :> "google" :> QueryParam "authorizationCode" Text :> QueryParam "redirectUri" Text :> Verb 'POST 200 '[JSON] CreateOAuthExchangeResult -- 'exchangeAuthorizationTokenAndCreateOrUpdateInbox' route
...
data MailSlurpBackend m = MailSlurpBackend
  { createTransformer :: Maybe Int -> Maybe Int -> Maybe Text -> Maybe AITranformCreateOptions -> m PageAITransformProjection{- ^ List all AI transforms -}
  , createTransformer1 :: AITranformCreateOptions -> m AITransformDto{- ^ Save an AI transform instructions and schema for use with webhooks and automations -}
  ...
  , getTransformerResults :: Maybe UUID -> Maybe UUID -> Maybe UUID -> Maybe Text -> Maybe Int -> Maybe Int -> Maybe Text -> m PageAITransformResultProjection{- ^ Get AI transformer results -}
  ...
  , createTotpDeviceForCustom :: CreateTotpDeviceOtpAuthUrlOptions -> m TotpDeviceDto{- ^ Create a virtual TOTP device for custom options specifying all parameters of the TOTP device. -}
  ...
  , getTotpDeviceCode :: UUID -> Maybe UTCTime -> m TotpDeviceCodeDto{- ^ Get Time-Based One-Time Password for a device by its ID. -}
  ...
  , createOAuthConnection :: Maybe Text -> Maybe Text -> Maybe Text -> m CreateOAuthConnectionResult{- ^ Configure an inbox for OAuth sync with MailSlurp -}
  , exchangeAuthorizationTokenAndCreateOrUpdateInbox :: Maybe Text -> Maybe Text -> m CreateOAuthExchangeResult{- ^ Exchange an OAuth code for an access token and create an inbox connection in MailSlurp -}
...
createMailSlurpClient = MailSlurpBackend{..}
  where
    ((coerce -> createTransformer) :<|>
     ...
     (coerce -> createOAuthConnection) :<|>
     (coerce -> exchangeAuthorizationTokenAndCreateOrUpdateInbox) :<|>
