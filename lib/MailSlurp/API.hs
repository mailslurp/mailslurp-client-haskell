...
data MailSlurpBackend m = MailSlurpBackend
  ...
  , getPhoneNumbers :: Maybe Text -> Maybe Text -> Maybe Text -> Maybe Text -> Maybe Text -> Maybe Text -> Maybe Int -> Maybe Int -> Maybe Text -> Maybe UTCTime -> Maybe UTCTime -> Maybe Text -> Maybe [UUID] -> Maybe Bool -> m PagePhoneNumberProjection{- ^ List phone numbers for account -}
