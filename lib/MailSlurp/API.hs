...
type MailSlurpAPI
    ...
    :<|> "inboxes" :> Capture "inboxId" UUID :> "rulesets" :> QueryParam "page" Int :> QueryParam "size" Int :> QueryParam "sort" Text :> Verb 'GET 200 '[JSON] () -- 'listInboxRulesets' route
    ...
    :<|> "rulesets" :> QueryParam "inboxId" UUID :> QueryParam "page" Int :> QueryParam "size" Int :> QueryParam "sort" Text :> Verb 'GET 200 '[JSON] PageInboxRulesetProjection -- 'getInboxRulesets' route
    ...
    :<|> "missed-emails" :> QueryParam "page" Int :> QueryParam "searchFilter" Text :> QueryParam "size" Int :> QueryParam "sort" Text :> Verb 'GET 200 '[JSON] PageMissedEmailProjection -- 'getAllMissedEmails' route
...
data MailSlurpBackend m = MailSlurpBackend
  ...
  , listInboxRulesets :: UUID -> Maybe Int -> Maybe Int -> Maybe Text -> m (){- ^ List all rulesets attached to an inbox -}
  ...
  , getInboxRulesets :: Maybe UUID -> Maybe Int -> Maybe Int -> Maybe Text -> m PageInboxRulesetProjection{- ^ List all rulesets attached to an inbox -}
  ...
  , getAllMissedEmails :: Maybe Int -> Maybe Text -> Maybe Int -> Maybe Text -> m PageMissedEmailProjection{- ^  -}
