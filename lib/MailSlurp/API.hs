...
type MailSlurpAPI
    ...
    :<|> "aliases" :> "threads" :> Capture "threadId" UUID :> Verb 'GET 200 '[JSON] ThreadProjection -- 'getThread' route
    :<|> "aliases" :> "threads" :> QueryParam "page" Int :> QueryParam "size" Int :> QueryParam "sort" Text :> QueryParam "since" UTCTime :> QueryParam "before" UTCTime :> Verb 'GET 200 '[JSON] PageThreadProjection -- 'getThreadsPaginated' route
    ...
    :<|> "attachments" :> "bytes" :> QueryParam "contentType" Text :> QueryParam "contentId" Text :> QueryParam "filename" Text :> Header "contentType" Text :> Header "filename" Text :> Verb 'POST 200 '[JSON] [Text] -- 'uploadAttachmentBytes' route
    :<|> "attachments" :> "multipart" :> QueryParam "contentId" Text :> QueryParam "contentType" Text :> QueryParam "filename" Text :> QueryParam "x-filename" Text :> ReqBody '[JSON] InlineObject :> Verb 'POST 200 '[JSON] [Text] -- 'uploadMultipartForm' route
    ...
    :<|> "connectors" :> ReqBody '[JSON] CreateConnectorOptions :> Verb 'POST 200 '[JSON] ConnectorDto -- 'createConnector' route
    ...
    :<|> "connectors" :> "events" :> QueryParam "page" Int :> QueryParam "size" Int :> QueryParam "sort" Text :> QueryParam "since" UTCTime :> QueryParam "before" UTCTime :> Verb 'GET 200 '[JSON] PageConnectorSyncEvents -- 'getAllConnectorSyncEvents' route
    :<|> "connectors" :> Capture "id" UUID :> Verb 'GET 200 '[JSON] ConnectorDto -- 'getConnector' route
    :<|> "connectors" :> "events" :> Capture "id" UUID :> Verb 'GET 200 '[JSON] ConnectorSyncEventDto -- 'getConnectorSyncEvent' route
    :<|> "connectors" :> Capture "id" UUID :> "events" :> QueryParam "page" Int :> QueryParam "size" Int :> QueryParam "sort" Text :> QueryParam "since" UTCTime :> QueryParam "before" UTCTime :> Verb 'GET 200 '[JSON] PageConnectorSyncEvents -- 'getConnectorSyncEvents' route
    ...
    :<|> "connectors" :> Capture "id" UUID :> "sync" :> Verb 'POST 200 '[JSON] ConnectorSyncRequestResult -- 'syncConnector' route
    ...
    :<|> "emails" :> Capture "emailId" UUID :> "contentPart" :> QueryParam "contentType" Text :> Verb 'GET 200 '[JSON] EmailContentPartResult -- 'getEmailContentPart' route
    :<|> "emails" :> "emails" :> "count" :> Verb 'GET 200 '[JSON] CountDto -- 'getEmailCount' route
    :<|> "emails" :> Capture "emailId" UUID :> "html" :> QueryParam "decode" Bool :> QueryParam "replaceCidImages" Bool :> Verb 'GET 200 '[JSON] Text -- 'getEmailHTML' route
    :<|> "emails" :> Capture "emailId" UUID :> "html" :> "json" :> QueryParam "decode" Bool :> QueryParam "replaceCidImages" Bool :> Verb 'GET 200 '[JSON] EmailHtmlDto -- 'getEmailHTMLJson' route
    ...
    :<|> "emails" :> "offset-paginated" :> QueryParam "inboxId" (QueryList 'MultiParamArray (UUID)) :> QueryParam "page" Int :> QueryParam "size" Int :> QueryParam "sort" Text :> QueryParam "unreadOnly" Bool :> QueryParam "searchFilter" Text :> QueryParam "since" UTCTime :> QueryParam "before" UTCTime :> Verb 'GET 200 '[JSON] PageEmailProjection -- 'getEmailsOffsetPaginated' route
    ...
    :<|> "emails" :> "search" :> ReqBody '[JSON] SearchEmailsOptions :> Verb 'POST 200 '[JSON] PageEmailProjection -- 'searchEmails' route
    ...
    :<|> "imap" :> "server" :> "fetch" :> QueryParam "inboxId" UUID :> QueryParam "seqNum" Int :> Verb 'POST 200 '[JSON] ImapServerFetchResult -- 'imapServerFetch' route
    ...
    :<|> "inboxes" :> QueryParam "size" Int :> QueryParam "sort" Text :> QueryParam "since" UTCTime :> QueryParam "excludeCatchAllInboxes" Bool :> QueryParam "before" UTCTime :> Verb 'GET 200 '[JSON] [InboxDto] -- 'getInboxes' route
    ...
    :<|> "forwarders" :> "events" :> QueryParam "page" Int :> QueryParam "size" Int :> QueryParam "inboxId" UUID :> QueryParam "sort" Text :> Verb 'GET 200 '[JSON] PageInboxForwarderEvents -- 'getAllInboxForwarderEvents' route
...
data MailSlurpBackend m = MailSlurpBackend
  ...
  , getThread :: UUID -> m ThreadProjection{- ^ Return a thread associated with an alias -}
  , getThreadsPaginated :: Maybe Int -> Maybe Int -> Maybe Text -> Maybe UTCTime -> Maybe UTCTime -> m PageThreadProjection{- ^ Returns threads created for all aliases in paginated form -}
  ...
  , uploadAttachmentBytes :: Maybe Text -> Maybe Text -> Maybe Text -> Maybe Text -> Maybe Text -> m [Text]{- ^  -}
  , uploadMultipartForm :: Maybe Text -> Maybe Text -> Maybe Text -> Maybe Text -> InlineObject -> m [Text]{- ^  -}
  ...
  , createConnector :: CreateConnectorOptions -> m ConnectorDto{- ^ Sync emails between external mailboxes and MailSlurp inboxes -}
  ...
  , getAllConnectorSyncEvents :: Maybe Int -> Maybe Int -> Maybe Text -> Maybe UTCTime -> Maybe UTCTime -> m PageConnectorSyncEvents{- ^  -}
  , getConnector :: UUID -> m ConnectorDto{- ^  -}
  , getConnectorSyncEvent :: UUID -> m ConnectorSyncEventDto{- ^  -}
  , getConnectorSyncEvents :: UUID -> Maybe Int -> Maybe Int -> Maybe Text -> Maybe UTCTime -> Maybe UTCTime -> m PageConnectorSyncEvents{- ^  -}
  ...
  , syncConnector :: UUID -> m ConnectorSyncRequestResult{- ^  -}
  ...
  , getEmailContentPart :: UUID -> Maybe Text -> m EmailContentPartResult{- ^ Get email body content parts from a multipart email message for a given content type -}
  , getEmailCount :: m CountDto{- ^  -}
  , getEmailHTML :: UUID -> Maybe Bool -> Maybe Bool -> m Text{- ^ Retrieve email content as HTML response for viewing in browsers. Decodes quoted-printable entities and converts charset to UTF-8. Pass your API KEY as a request parameter when viewing in a browser: `?apiKey=xxx`. Returns content-type `text/html;charset=utf-8` so you must call expecting that content response not JSON. For JSON response see the `getEmailHTMLJson` method. -}
  , getEmailHTMLJson :: UUID -> Maybe Bool -> Maybe Bool -> m EmailHtmlDto{- ^ Retrieve email content as HTML response. Decodes quoted-printable entities and converts charset to UTF-8. Returns content-type `application/json;charset=utf-8` so you must call expecting that content response not JSON. -}
  ...
  , searchEmails :: SearchEmailsOptions -> m PageEmailProjection{- ^ Search emails by given criteria return matches in paginated format. Searches against email recipients, sender, subject, email address and ID. Does not search email body -}
  ...
  , deleteAllValidationRequests :: m (){- ^  -}
  , deleteValidationRequest :: UUID -> m (){- ^  -}
  ...
  , imapServerFetch :: Maybe UUID -> Maybe Int -> m ImapServerFetchResult{- ^  -}
  ...
  , getInboxes :: Maybe Int -> Maybe Text -> Maybe UTCTime -> Maybe Bool -> Maybe UTCTime -> m [InboxDto]{- ^ List the inboxes you have created. Note use of the more advanced `getAllInboxes` is recommended and allows paginated access using a limit and sort parameter. -}
  ...
  , getAllInboxForwarderEvents :: Maybe Int -> Maybe Int -> Maybe UUID -> Maybe Text -> m PageInboxForwarderEvents{- ^ Get all inbox forwarder events -}
  ...
  , getFakeEmailById :: Maybe UUID -> m FakeEmailResult{- ^  -}
  , getFakeEmailsForAddress :: Maybe Int -> Maybe Text -> m [FakeEmailPreview]{- ^  -}
...
createMailSlurpClient = MailSlurpBackend{..}
  where
    ((coerce -> createAlias) :<|>
     ...
     (coerce -> getAllConnectorSyncEvents) :<|>
     (coerce -> getConnector) :<|>
     (coerce -> getConnectorSyncEvent) :<|>
     (coerce -> getConnectorSyncEvents) :<|>
