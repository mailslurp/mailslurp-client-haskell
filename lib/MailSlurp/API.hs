...
type MailSlurpAPI
    ...
    :<|> "phone" :> "numbers" :> "by-name" :> Verb 'GET 200 '[JSON] PhoneNumberDto -- 'getPhoneNumberByName' route
    :<|> "phone" :> "numbers" :> "by-phone-number" :> Verb 'GET 200 '[JSON] PhoneNumberDto -- 'getPhoneNumberByPhoneNumber' route
...
data MailSlurpBackend m = MailSlurpBackend
  ...
  , getPhoneNumberByName :: m PhoneNumberDto{- ^ Get a phone number by name -}
  , getPhoneNumberByPhoneNumber :: m PhoneNumberDto{- ^ Get a phone number by phone number -}
