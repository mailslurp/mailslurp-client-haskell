...
type MailSlurpAPI
    ...
    :<|> "aliases" :> Capture "aliasId" UUID :> "emails" :> QueryParam "before" UTCTime :> QueryParam "page" Int :> QueryParam "since" UTCTime :> QueryParam "size" Int :> QueryParam "sort" Text :> Verb 'GET 200 '[JSON] PageEmailProjection -- 'getAliasEmails' route
    :<|> "aliases" :> Capture "aliasId" UUID :> "threads" :> QueryParam "before" UTCTime :> QueryParam "page" Int :> QueryParam "since" UTCTime :> QueryParam "size" Int :> QueryParam "sort" Text :> Verb 'GET 200 '[JSON] PageThreadProjection -- 'getAliasThreads' route
    :<|> "aliases" :> QueryParam "before" UTCTime :> QueryParam "page" Int :> QueryParam "since" UTCTime :> QueryParam "size" Int :> QueryParam "sort" Text :> Verb 'GET 200 '[JSON] PageAlias -- 'getAliases' route
    ...
    :<|> "attachments" :> QueryParam "before" UTCTime :> QueryParam "fileNameFilter" Text :> QueryParam "page" Int :> QueryParam "since" UTCTime :> QueryParam "size" Int :> QueryParam "sort" Text :> Verb 'GET 200 '[JSON] PageAttachmentEntity -- 'getAttachments' route
    ...
    :<|> "bounce" :> "emails" :> QueryParam "before" UTCTime :> QueryParam "page" Int :> QueryParam "since" UTCTime :> QueryParam "size" Int :> QueryParam "sort" Text :> Verb 'GET 200 '[JSON] PageBouncedEmail -- 'getBouncedEmails' route
    :<|> "bounce" :> "recipients" :> Capture "id" UUID :> Verb 'GET 200 '[JSON] BouncedRecipientDto -- 'getBouncedRecipient' route
    :<|> "bounce" :> "recipients" :> QueryParam "before" UTCTime :> QueryParam "page" Int :> QueryParam "since" UTCTime :> QueryParam "size" Int :> QueryParam "sort" Text :> Verb 'GET 200 '[JSON] PageBouncedRecipients -- 'getBouncedRecipients' route
    ...
    :<|> "createInbox" :> QueryParam "allowTeamAccess" Bool :> QueryParam "description" Text :> QueryParam "emailAddress" Text :> QueryParam "expiresAt" UTCTime :> QueryParam "expiresIn" Integer :> QueryParam "favourite" Bool :> QueryParam "inboxType" Text :> QueryParam "name" Text :> QueryParam "tags" (QueryList 'MultiParamArray (Text)) :> QueryParam "useDomainPool" Bool :> Verb 'POST 200 '[JSON] Inbox -- 'createNewEmailAddress' route
    :<|> "newEmailAddress" :> QueryParam "allowTeamAccess" Bool :> QueryParam "description" Text :> QueryParam "emailAddress" Text :> QueryParam "expiresAt" UTCTime :> QueryParam "expiresIn" Integer :> QueryParam "favourite" Bool :> QueryParam "inboxType" Text :> QueryParam "name" Text :> QueryParam "tags" (QueryList 'MultiParamArray (Text)) :> QueryParam "useDomainPool" Bool :> Verb 'POST 200 '[JSON] Inbox -- 'createNewEmailAddress1' route
    ...
    :<|> "contacts" :> "paginated" :> QueryParam "before" UTCTime :> QueryParam "page" Int :> QueryParam "since" UTCTime :> QueryParam "size" Int :> QueryParam "sort" Text :> Verb 'GET 200 '[JSON] PageContactProjection -- 'getAllContacts' route
    ...
    :<|> "emails" :> QueryParam "before" UTCTime :> QueryParam "inboxId" (QueryList 'MultiParamArray (UUID)) :> QueryParam "page" Int :> QueryParam "searchFilter" Text :> QueryParam "since" UTCTime :> QueryParam "size" Int :> QueryParam "sort" Text :> QueryParam "unreadOnly" Bool :> Verb 'GET 200 '[JSON] PageEmailProjection -- 'getEmailsPaginated' route
    ...
    :<|> "emails" :> "organization" :> QueryParam "before" UTCTime :> QueryParam "inboxId" (QueryList 'MultiParamArray (UUID)) :> QueryParam "page" Int :> QueryParam "searchFilter" Text :> QueryParam "since" UTCTime :> QueryParam "size" Int :> QueryParam "sort" Text :> QueryParam "unreadOnly" Bool :> Verb 'GET 200 '[JSON] PageEmailProjection -- 'getOrganizationEmailsPaginated' route
    ...
    :<|> "expired" :> QueryParam "before" UTCTime :> QueryParam "page" Int :> QueryParam "since" UTCTime :> QueryParam "size" Int :> QueryParam "sort" Text :> Verb 'GET 200 '[JSON] PageExpiredInboxRecordProjection -- 'getExpiredInboxes' route
    ...
    :<|> "groups" :> "paginated" :> QueryParam "before" UTCTime :> QueryParam "page" Int :> QueryParam "since" UTCTime :> QueryParam "size" Int :> QueryParam "sort" Text :> Verb 'GET 200 '[JSON] PageGroupProjection -- 'getAllGroups' route
    ...
    :<|> "groups" :> Capture "groupId" UUID :> "contacts-paginated" :> QueryParam "before" UTCTime :> QueryParam "page" Int :> QueryParam "since" UTCTime :> QueryParam "size" Int :> QueryParam "sort" Text :> Verb 'GET 200 '[JSON] PageContactProjection -- 'getGroupWithContactsPaginated' route
    ...
    :<|> "inboxes" :> "paginated" :> QueryParam "before" UTCTime :> QueryParam "favourite" Bool :> QueryParam "page" Int :> QueryParam "search" Text :> QueryParam "since" UTCTime :> QueryParam "size" Int :> QueryParam "sort" Text :> QueryParam "tag" Text :> QueryParam "teamAccess" Bool :> Verb 'GET 200 '[JSON] PageInboxProjection -- 'getAllInboxes' route
    :<|> "inboxes" :> Capture "inboxId" UUID :> "emails" :> QueryParam "before" UTCTime :> QueryParam "delayTimeout" Integer :> QueryParam "limit" Int :> QueryParam "minCount" Integer :> QueryParam "retryTimeout" Integer :> QueryParam "since" UTCTime :> QueryParam "size" Int :> QueryParam "sort" Text :> QueryParam "unreadOnly" Bool :> Verb 'GET 200 '[JSON] [EmailPreview] -- 'getEmails' route
    ...
    :<|> "inboxes" :> Capture "inboxId" UUID :> "emails" :> "paginated" :> QueryParam "before" UTCTime :> QueryParam "page" Int :> QueryParam "since" UTCTime :> QueryParam "size" Int :> QueryParam "sort" Text :> Verb 'GET 200 '[JSON] PageEmailPreview -- 'getInboxEmailsPaginated' route
    :<|> "inboxes" :> Capture "inboxId" UUID :> "sent" :> QueryParam "before" UTCTime :> QueryParam "page" Int :> QueryParam "searchFilter" Text :> QueryParam "since" UTCTime :> QueryParam "size" Int :> QueryParam "sort" Text :> Verb 'GET 200 '[JSON] PageSentEmailProjection -- 'getInboxSentEmails' route
    :<|> "inboxes" :> "tags" :> Verb 'GET 200 '[JSON] [Text] -- 'getInboxTags' route
    :<|> "inboxes" :> QueryParam "before" UTCTime :> QueryParam "since" UTCTime :> QueryParam "size" Int :> QueryParam "sort" Text :> Verb 'GET 200 '[JSON] [Inbox] -- 'getInboxes' route
    :<|> "inboxes" :> "organization" :> QueryParam "before" UTCTime :> QueryParam "page" Int :> QueryParam "searchFilter" Text :> QueryParam "since" UTCTime :> QueryParam "size" Int :> QueryParam "sort" Text :> Verb 'GET 200 '[JSON] PageOrganizationInboxProjection -- 'getOrganizationInboxes' route
    :<|> "inboxes" :> Capture "inboxId" UUID :> "rulesets" :> QueryParam "before" UTCTime :> QueryParam "page" Int :> QueryParam "searchFilter" Text :> QueryParam "since" UTCTime :> QueryParam "size" Int :> QueryParam "sort" Text :> Verb 'GET 200 '[JSON] PageInboxRulesetDto -- 'listInboxRulesets' route
    :<|> "inboxes" :> Capture "inboxId" UUID :> "tracking-pixels" :> QueryParam "before" UTCTime :> QueryParam "page" Int :> QueryParam "searchFilter" Text :> QueryParam "since" UTCTime :> QueryParam "size" Int :> QueryParam "sort" Text :> Verb 'GET 200 '[JSON] PageTrackingPixelProjection -- 'listInboxTrackingPixels' route
    ...
    :<|> "forwarders" :> QueryParam "before" UTCTime :> QueryParam "inboxId" UUID :> QueryParam "page" Int :> QueryParam "searchFilter" Text :> QueryParam "since" UTCTime :> QueryParam "size" Int :> QueryParam "sort" Text :> Verb 'GET 200 '[JSON] PageInboxForwarderDto -- 'getInboxForwarders' route
    ...
    :<|> "rulesets" :> QueryParam "before" UTCTime :> QueryParam "inboxId" UUID :> QueryParam "page" Int :> QueryParam "searchFilter" Text :> QueryParam "since" UTCTime :> QueryParam "size" Int :> QueryParam "sort" Text :> Verb 'GET 200 '[JSON] PageInboxRulesetDto -- 'getInboxRulesets' route
    ...
    :<|> "missed-emails" :> QueryParam "before" UTCTime :> QueryParam "inboxId" UUID :> QueryParam "page" Int :> QueryParam "searchFilter" Text :> QueryParam "since" UTCTime :> QueryParam "size" Int :> QueryParam "sort" Text :> Verb 'GET 200 '[JSON] PageMissedEmailProjection -- 'getAllMissedEmails' route
    :<|> "missed-emails" :> "unknown" :> QueryParam "before" UTCTime :> QueryParam "inboxId" UUID :> QueryParam "page" Int :> QueryParam "searchFilter" Text :> QueryParam "since" UTCTime :> QueryParam "size" Int :> QueryParam "sort" Text :> Verb 'GET 200 '[JSON] PageUnknownMissedEmailProjection -- 'getAllUnknownMissedEmails' route
    :<|> "missed-emails" :> Capture "missedEmailId" UUID :> Verb 'GET 200 '[JSON] MissedEmail -- 'getMissedEmail' route
    :<|> "missed-emails" :> "waitForNthMissedEmail" :> QueryParam "before" UTCTime :> QueryParam "inboxId" UUID :> QueryParam "index" Int :> QueryParam "since" UTCTime :> QueryParam "timeout" Integer :> Verb 'GET 200 '[JSON] MissedEmail -- 'waitForNthMissedEmail' route
    :<|> "sent" :> "tracking-pixels" :> QueryParam "before" UTCTime :> QueryParam "page" Int :> QueryParam "searchFilter" Text :> QueryParam "since" UTCTime :> QueryParam "size" Int :> QueryParam "sort" Text :> Verb 'GET 200 '[JSON] PageTrackingPixelProjection -- 'getAllSentTrackingPixels' route
    ...
    :<|> "sent" :> Capture "id" UUID :> "tracking-pixels" :> QueryParam "before" UTCTime :> QueryParam "page" Int :> QueryParam "searchFilter" Text :> QueryParam "since" UTCTime :> QueryParam "size" Int :> QueryParam "sort" Text :> Verb 'GET 200 '[JSON] PageTrackingPixelProjection -- 'getSentEmailTrackingPixels' route
    :<|> "sent" :> QueryParam "before" UTCTime :> QueryParam "inboxId" UUID :> QueryParam "page" Int :> QueryParam "searchFilter" Text :> QueryParam "since" UTCTime :> QueryParam "size" Int :> QueryParam "sort" Text :> Verb 'GET 200 '[JSON] PageSentEmailProjection -- 'getSentEmails' route
    :<|> "sent" :> "organization" :> QueryParam "before" UTCTime :> QueryParam "inboxId" UUID :> QueryParam "page" Int :> QueryParam "searchFilter" Text :> QueryParam "since" UTCTime :> QueryParam "size" Int :> QueryParam "sort" Text :> Verb 'GET 200 '[JSON] PageSentEmailProjection -- 'getSentOrganizationEmails' route
    ...
    :<|> "templates" :> "paginated" :> QueryParam "before" UTCTime :> QueryParam "page" Int :> QueryParam "since" UTCTime :> QueryParam "size" Int :> QueryParam "sort" Text :> Verb 'GET 200 '[JSON] PageTemplateProjection -- 'getAllTemplates' route
    ...
    :<|> "tracking" :> "pixels" :> QueryParam "before" UTCTime :> QueryParam "page" Int :> QueryParam "searchFilter" Text :> QueryParam "since" UTCTime :> QueryParam "size" Int :> QueryParam "sort" Text :> Verb 'GET 200 '[JSON] PageTrackingPixelProjection -- 'getAllTrackingPixels' route
    ...
    :<|> "waitForEmailCount" :> QueryParam "before" UTCTime :> QueryParam "count" Int :> QueryParam "delay" Integer :> QueryParam "inboxId" UUID :> QueryParam "since" UTCTime :> QueryParam "sort" Text :> QueryParam "timeout" Integer :> QueryParam "unreadOnly" Bool :> Verb 'GET 200 '[JSON] [EmailPreview] -- 'waitForEmailCount' route
    :<|> "waitForLatestEmail" :> QueryParam "before" UTCTime :> QueryParam "delay" Integer :> QueryParam "inboxId" UUID :> QueryParam "since" UTCTime :> QueryParam "sort" Text :> QueryParam "timeout" Integer :> QueryParam "unreadOnly" Bool :> Verb 'GET 200 '[JSON] Email -- 'waitForLatestEmail' route
    :<|> "waitForMatchingEmails" :> QueryParam "before" UTCTime :> QueryParam "count" Int :> QueryParam "delay" Integer :> QueryParam "inboxId" UUID :> QueryParam "since" UTCTime :> QueryParam "sort" Text :> QueryParam "timeout" Integer :> QueryParam "unreadOnly" Bool :> ReqBody '[JSON] MatchOptions :> Verb 'POST 200 '[JSON] [EmailPreview] -- 'waitForMatchingEmails' route
    :<|> "waitForMatchingFirstEmail" :> QueryParam "before" UTCTime :> QueryParam "delay" Integer :> QueryParam "inboxId" UUID :> QueryParam "since" UTCTime :> QueryParam "sort" Text :> QueryParam "timeout" Integer :> QueryParam "unreadOnly" Bool :> ReqBody '[JSON] MatchOptions :> Verb 'POST 200 '[JSON] Email -- 'waitForMatchingFirstEmail' route
    :<|> "waitForNthEmail" :> QueryParam "before" UTCTime :> QueryParam "delay" Integer :> QueryParam "inboxId" UUID :> QueryParam "index" Int :> QueryParam "since" UTCTime :> QueryParam "sort" Text :> QueryParam "timeout" Integer :> QueryParam "unreadOnly" Bool :> Verb 'GET 200 '[JSON] Email -- 'waitForNthEmail' route
    ...
    :<|> "webhooks" :> Verb 'DELETE 200 '[JSON] () -- 'deleteAllWebhooks' route
    :<|> "inboxes" :> Capture "inboxId" UUID :> "webhooks" :> Capture "webhookId" UUID :> Verb 'DELETE 200 '[JSON] () -- 'deleteWebhook' route
    :<|> "webhooks" :> "results" :> QueryParam "before" UTCTime :> QueryParam "page" Int :> QueryParam "searchFilter" Text :> QueryParam "since" UTCTime :> QueryParam "size" Int :> QueryParam "sort" Text :> QueryParam "unseenOnly" Bool :> Verb 'GET 200 '[JSON] PageWebhookResult -- 'getAllWebhookResults' route
    :<|> "webhooks" :> "paginated" :> QueryParam "before" UTCTime :> QueryParam "page" Int :> QueryParam "searchFilter" Text :> QueryParam "since" UTCTime :> QueryParam "size" Int :> QueryParam "sort" Text :> Verb 'GET 200 '[JSON] PageWebhookProjection -- 'getAllWebhooks' route
    :<|> "inboxes" :> Capture "inboxId" UUID :> "webhooks" :> "paginated" :> QueryParam "before" UTCTime :> QueryParam "page" Int :> QueryParam "searchFilter" Text :> QueryParam "since" UTCTime :> QueryParam "size" Int :> QueryParam "sort" Text :> Verb 'GET 200 '[JSON] PageWebhookProjection -- 'getInboxWebhooksPaginated' route
    ...
    :<|> "webhooks" :> Capture "webhookId" UUID :> "results" :> QueryParam "before" UTCTime :> QueryParam "page" Int :> QueryParam "searchFilter" Text :> QueryParam "since" UTCTime :> QueryParam "size" Int :> QueryParam "sort" Text :> QueryParam "unseenOnly" Bool :> Verb 'GET 200 '[JSON] PageWebhookResult -- 'getWebhookResults' route
...
data MailSlurpBackend m = MailSlurpBackend
  ...
  , getAliasEmails :: UUID -> Maybe UTCTime -> Maybe Int -> Maybe UTCTime -> Maybe Int -> Maybe Text -> m PageEmailProjection{- ^ Get paginated emails for an alias by ID -}
  , getAliasThreads :: UUID -> Maybe UTCTime -> Maybe Int -> Maybe UTCTime -> Maybe Int -> Maybe Text -> m PageThreadProjection{- ^ Returns threads created for an email alias in paginated form -}
  , getAliases :: Maybe UTCTime -> Maybe Int -> Maybe UTCTime -> Maybe Int -> Maybe Text -> m PageAlias{- ^ Get all email aliases in paginated form -}
  ...
  , getAttachments :: Maybe UTCTime -> Maybe Text -> Maybe Int -> Maybe UTCTime -> Maybe Int -> Maybe Text -> m PageAttachmentEntity{- ^ Get all attachments in paginated response. Each entity contains meta data for the attachment such as `name` and `content-type`. Use the `attachmentId` and the download endpoints to get the file contents. -}
  ...
  , getBouncedEmails :: Maybe UTCTime -> Maybe Int -> Maybe UTCTime -> Maybe Int -> Maybe Text -> m PageBouncedEmail{- ^ Bounced emails are email you have sent that were rejected by a recipient -}
  , getBouncedRecipient :: UUID -> m BouncedRecipientDto{- ^ Bounced emails are email you have sent that were rejected by a recipient -}
  , getBouncedRecipients :: Maybe UTCTime -> Maybe Int -> Maybe UTCTime -> Maybe Int -> Maybe Text -> m PageBouncedRecipients{- ^ Bounced recipients are email addresses that you have sent emails to that did not accept the sent email. Once a recipient is bounced you cannot send emails to that address. -}
  , bulkCreateInboxes :: Maybe Int -> m [Inbox]{- ^  -}
  , bulkDeleteInboxes :: [UUID] -> m (){- ^  -}
  , bulkSendEmails :: BulkSendEmailOptions -> m (){- ^  -}
  , createNewEmailAddress :: Maybe Bool -> Maybe Text -> Maybe Text -> Maybe UTCTime -> Maybe Integer -> Maybe Bool -> Maybe Text -> Maybe Text -> Maybe [Text] -> Maybe Bool -> m Inbox{- ^ Returns an Inbox with an `id` and an `emailAddress` -}
  , createNewEmailAddress1 :: Maybe Bool -> Maybe Text -> Maybe Text -> Maybe UTCTime -> Maybe Integer -> Maybe Bool -> Maybe Text -> Maybe Text -> Maybe [Text] -> Maybe Bool -> m Inbox{- ^ Returns an Inbox with an `id` and an `emailAddress` -}
  ...
  , getAllContacts :: Maybe UTCTime -> Maybe Int -> Maybe UTCTime -> Maybe Int -> Maybe Text -> m PageContactProjection{- ^  -}
  ...
  , getEmailsPaginated :: Maybe UTCTime -> Maybe [UUID] -> Maybe Int -> Maybe Text -> Maybe UTCTime -> Maybe Int -> Maybe Text -> Maybe Bool -> m PageEmailProjection{- ^ By default returns all emails across all inboxes sorted by ascending created at date. Responses are paginated. You can restrict results to a list of inbox IDs. You can also filter out read messages -}
  ...
  , getOrganizationEmailsPaginated :: Maybe UTCTime -> Maybe [UUID] -> Maybe Int -> Maybe Text -> Maybe UTCTime -> Maybe Int -> Maybe Text -> Maybe Bool -> m PageEmailProjection{- ^ By default returns all emails across all team inboxes sorted by ascending created at date. Responses are paginated. You can restrict results to a list of inbox IDs. You can also filter out read messages -}
  ...
  , getExpiredInboxes :: Maybe UTCTime -> Maybe Int -> Maybe UTCTime -> Maybe Int -> Maybe Text -> m PageExpiredInboxRecordProjection{- ^ Inboxes created with an expiration date will expire after the given date. An ExpiredInboxRecord is created that records the inboxes old ID and email address. You can still read emails in the inbox (using the inboxes old ID) but the email address associated with the inbox can no longer send or receive emails. Fetch expired inbox records to view the old inboxes properties -}
  ...
  , deleteGroup :: UUID -> m (){- ^  -}
  , getAllGroups :: Maybe UTCTime -> Maybe Int -> Maybe UTCTime -> Maybe Int -> Maybe Text -> m PageGroupProjection{- ^  -}
  , getGroup :: UUID -> m GroupDto{- ^  -}
  , getGroupWithContacts :: UUID -> m GroupContactsDto{- ^  -}
  , getGroupWithContactsPaginated :: UUID -> Maybe UTCTime -> Maybe Int -> Maybe UTCTime -> Maybe Int -> Maybe Text -> m PageContactProjection{- ^  -}
  ...
  , getAllInboxes :: Maybe UTCTime -> Maybe Bool -> Maybe Int -> Maybe Text -> Maybe UTCTime -> Maybe Int -> Maybe Text -> Maybe Text -> Maybe Bool -> m PageInboxProjection{- ^ List inboxes in paginated form. The results are available on the `content` property of the returned object. This method allows for page index (zero based), page size (how many results to return), and a sort direction (based on createdAt time). You Can also filter by whether an inbox is favorited or use email address pattern. This method is the recommended way to query inboxes. The alternative `getInboxes` method returns a full list of inboxes but is limited to 100 results. -}
  , getEmails :: UUID -> Maybe UTCTime -> Maybe Integer -> Maybe Int -> Maybe Integer -> Maybe Integer -> Maybe UTCTime -> Maybe Int -> Maybe Text -> Maybe Bool -> m [EmailPreview]{- ^ List emails that an inbox has received. Only emails that are sent to the inbox's email address will appear in the inbox. It may take several seconds for any email you send to an inbox's email address to appear in the inbox. To make this endpoint wait for a minimum number of emails use the `minCount` parameter. The server will retry the inbox database until the `minCount` is satisfied or the `retryTimeout` is reached -}
  ...
  , getInboxEmailsPaginated :: UUID -> Maybe UTCTime -> Maybe Int -> Maybe UTCTime -> Maybe Int -> Maybe Text -> m PageEmailPreview{- ^ Get a paginated list of emails in an inbox. Does not hold connections open. -}
  , getInboxSentEmails :: UUID -> Maybe UTCTime -> Maybe Int -> Maybe Text -> Maybe UTCTime -> Maybe Int -> Maybe Text -> m PageSentEmailProjection{- ^ Returns an inbox's sent email receipts. Call individual sent email endpoints for more details. Note for privacy reasons the full body of sent emails is never stored. An MD5 hash hex is available for comparison instead. -}
  , getInboxTags :: m [Text]{- ^ Get all inbox tags -}
  , getInboxes :: Maybe UTCTime -> Maybe UTCTime -> Maybe Int -> Maybe Text -> m [Inbox]{- ^ List the inboxes you have created. Note use of the more advanced `getAllEmails` is recommended and allows paginated access using a limit and sort parameter. -}
  , getOrganizationInboxes :: Maybe UTCTime -> Maybe Int -> Maybe Text -> Maybe UTCTime -> Maybe Int -> Maybe Text -> m PageOrganizationInboxProjection{- ^ List organization inboxes in paginated form. These are inboxes created with `allowTeamAccess` flag enabled. Organization inboxes are `readOnly` for non-admin users. The results are available on the `content` property of the returned object. This method allows for page index (zero based), page size (how many results to return), and a sort direction (based on createdAt time).  -}
  , listInboxRulesets :: UUID -> Maybe UTCTime -> Maybe Int -> Maybe Text -> Maybe UTCTime -> Maybe Int -> Maybe Text -> m PageInboxRulesetDto{- ^ List all rulesets attached to an inbox -}
  , listInboxTrackingPixels :: UUID -> Maybe UTCTime -> Maybe Int -> Maybe Text -> Maybe UTCTime -> Maybe Int -> Maybe Text -> m PageTrackingPixelProjection{- ^ List all tracking pixels sent from an inbox -}
  ...
  , getInboxForwarders :: Maybe UTCTime -> Maybe UUID -> Maybe Int -> Maybe Text -> Maybe UTCTime -> Maybe Int -> Maybe Text -> m PageInboxForwarderDto{- ^ List all forwarders attached to an inbox -}
  ...
  , getInboxRulesets :: Maybe UTCTime -> Maybe UUID -> Maybe Int -> Maybe Text -> Maybe UTCTime -> Maybe Int -> Maybe Text -> m PageInboxRulesetDto{- ^ List all rulesets attached to an inbox -}
  ...
  , getAllMissedEmails :: Maybe UTCTime -> Maybe UUID -> Maybe Int -> Maybe Text -> Maybe UTCTime -> Maybe Int -> Maybe Text -> m PageMissedEmailProjection{- ^  -}
  , getAllUnknownMissedEmails :: Maybe UTCTime -> Maybe UUID -> Maybe Int -> Maybe Text -> Maybe UTCTime -> Maybe Int -> Maybe Text -> m PageUnknownMissedEmailProjection{- ^ Unknown missed emails are emails that were sent to MailSlurp but could not be assigned to an existing inbox. -}
  , getMissedEmail :: UUID -> m MissedEmail{- ^  -}
  , waitForNthMissedEmail :: Maybe UTCTime -> Maybe UUID -> Maybe Int -> Maybe UTCTime -> Maybe Integer -> m MissedEmail{- ^ Wait for 0 based index missed email -}
  , getAllSentTrackingPixels :: Maybe UTCTime -> Maybe Int -> Maybe Text -> Maybe UTCTime -> Maybe Int -> Maybe Text -> m PageTrackingPixelProjection{- ^  -}
  , getSentEmail :: UUID -> m SentEmailDto{- ^  -}
  , getSentEmailHTMLContent :: UUID -> m Text{- ^  -}
  , getSentEmailTrackingPixels :: UUID -> Maybe UTCTime -> Maybe Int -> Maybe Text -> Maybe UTCTime -> Maybe Int -> Maybe Text -> m PageTrackingPixelProjection{- ^  -}
  , getSentEmails :: Maybe UTCTime -> Maybe UUID -> Maybe Int -> Maybe Text -> Maybe UTCTime -> Maybe Int -> Maybe Text -> m PageSentEmailProjection{- ^  -}
  , getSentOrganizationEmails :: Maybe UTCTime -> Maybe UUID -> Maybe Int -> Maybe Text -> Maybe UTCTime -> Maybe Int -> Maybe Text -> m PageSentEmailProjection{- ^  -}
  , createTemplate :: CreateTemplateOptions -> m TemplateDto{- ^  -}
  , deleteTemplate :: UUID -> m (){- ^  -}
  , getAllTemplates :: Maybe UTCTime -> Maybe Int -> Maybe UTCTime -> Maybe Int -> Maybe Text -> m PageTemplateProjection{- ^  -}
  ...
  , getAllTrackingPixels :: Maybe UTCTime -> Maybe Int -> Maybe Text -> Maybe UTCTime -> Maybe Int -> Maybe Text -> m PageTrackingPixelProjection{- ^ List tracking pixels in paginated form -}
  ...
  , getAllWebhookResults :: Maybe UTCTime -> Maybe Int -> Maybe Text -> Maybe UTCTime -> Maybe Int -> Maybe Text -> Maybe Bool -> m PageWebhookResult{- ^  -}
  , getAllWebhooks :: Maybe UTCTime -> Maybe Int -> Maybe Text -> Maybe UTCTime -> Maybe Int -> Maybe Text -> m PageWebhookProjection{- ^ List webhooks in paginated form. Allows for page index, page size, and sort direction. -}
  , getInboxWebhooksPaginated :: UUID -> Maybe UTCTime -> Maybe Int -> Maybe Text -> Maybe UTCTime -> Maybe Int -> Maybe Text -> m PageWebhookProjection{- ^  -}
  , getJsonSchemaForWebhookPayload :: UUID -> m JSONSchemaDto{- ^  -}
  ...
  , getTestWebhookPayloadForWebhook :: UUID -> m AbstractWebhookPayload{- ^  -}
  ...
  , getWebhookResults :: UUID -> Maybe UTCTime -> Maybe Int -> Maybe Text -> Maybe UTCTime -> Maybe Int -> Maybe Text -> Maybe Bool -> m PageWebhookResult{- ^  -}
