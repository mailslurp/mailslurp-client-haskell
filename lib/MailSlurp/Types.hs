...
data DeliveryStatus = DeliveryStatus
  { deliveryStatusId :: Maybe UUID -- ^ 
  , deliveryStatusUserId :: UUID -- ^ 
  , deliveryStatusSentId :: Maybe UUID -- ^ 
  , deliveryStatusRemoteMtaIp :: Maybe Text -- ^ 
  , deliveryStatusInboxId :: Maybe UUID -- ^ 
  , deliveryStatusReportingMta :: Maybe Text -- ^ 
  , deliveryStatusRecipients :: Maybe [Text] -- ^ 
  , deliveryStatusSmtpResponse :: Maybe Text -- ^ 
  , deliveryStatusProcessingTimeMillis :: Maybe Integer -- ^ 
  , deliveryStatusReceived :: Maybe UTCTime -- ^ 
  , deliveryStatusSubject :: Maybe Text -- ^ 
  , deliveryStatusCreatedAt :: UTCTime -- ^ 
  , deliveryStatusUpdatedAt :: UTCTime -- ^ 
  } deriving (Show, Eq, Generic, Data)

instance FromJSON DeliveryStatus where
  parseJSON = genericParseJSON (removeFieldLabelPrefix True "deliveryStatus")
instance ToJSON DeliveryStatus where
  toJSON = genericToJSON (removeFieldLabelPrefix False "deliveryStatus")
...
data PageDeliveryStatus = PageDeliveryStatus
  { pageDeliveryStatusContent :: Maybe [DeliveryStatus] -- ^ 
...
data SmsMessage = SmsMessage
  { smsMessageId :: Maybe UUID -- ^ 
  , smsMessageUserId :: UUID -- ^ 
  , smsMessagePhoneNumber :: UUID -- ^ 
  , smsMessageFromNumber :: Text -- ^ 
  , smsMessageBody :: Text -- ^ 
  , smsMessageRead :: Bool -- ^ 
  , smsMessageSid :: Text -- ^ 
  , smsMessageCreatedAt :: UTCTime -- ^ 
  , smsMessageUpdatedAt :: UTCTime -- ^ 
  } deriving (Show, Eq, Generic, Data)

instance FromJSON SmsMessage where
  parseJSON = genericParseJSON (removeFieldLabelPrefix True "smsMessage")
instance ToJSON SmsMessage where
  toJSON = genericToJSON (removeFieldLabelPrefix False "smsMessage")
