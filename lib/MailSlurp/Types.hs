...
data ConnectorDto = ConnectorDto
  ...
  , connectorDtoConnectorType :: Text -- ^ 
  , connectorDtoConnectorAuthType :: Text -- ^ 
  , connectorDtoSyncEnabled :: Bool -- ^ 
  , connectorDtoSyncScheduleType :: Text -- ^ 
  , connectorDtoSyncInterval :: Maybe Int -- ^ 
  , connectorDtoImapHost :: Maybe Text -- ^ 
  , connectorDtoImapPort :: Maybe Int -- ^ 
  , connectorDtoImapUsername :: Maybe Text -- ^ 
  , connectorDtoImapPassword :: Maybe Text -- ^ 
  , connectorDtoImapSsl :: Maybe Bool -- ^ 
...
data ConnectorProjection = ConnectorProjection
  { connectorProjectionId :: Maybe UUID -- ^ 
  , connectorProjectionUserId :: UUID -- ^ 
  , connectorProjectionInboxId :: UUID -- ^ 
  , connectorProjectionCreatedAt :: UTCTime -- ^ 
  , connectorProjectionConnectorType :: Text -- ^ 
  , connectorProjectionSyncScheduleType :: Text -- ^ 
  , connectorProjectionSyncInterval :: Maybe Int -- ^ 
  , connectorProjectionSyncEnabled :: Bool -- ^ 
  } deriving (Show, Eq, Generic, Data)
...
-- | 
data ConnectorSyncEventDto = ConnectorSyncEventDto
  { connectorSyncEventDtoId :: UUID -- ^ 
  , connectorSyncEventDtoConnectorId :: UUID -- ^ 
  , connectorSyncEventDtoSyncStatus :: Text -- ^ 
  , connectorSyncEventDtoSyncCount :: Integer -- ^ 
  , connectorSyncEventDtoMessage :: Maybe Text -- ^ 
  , connectorSyncEventDtoCreatedAt :: UTCTime -- ^ 
  } deriving (Show, Eq, Generic, Data)

instance FromJSON ConnectorSyncEventDto where
  parseJSON = genericParseJSON (removeFieldLabelPrefix True "connectorSyncEventDto")
instance ToJSON ConnectorSyncEventDto where
  toJSON = genericToJSON (removeFieldLabelPrefix False "connectorSyncEventDto")


-- | ConnectorSyncEventProjection
data ConnectorSyncEventProjection = ConnectorSyncEventProjection
  { connectorSyncEventProjectionMessage :: Maybe Text -- ^ 
  , connectorSyncEventProjectionId :: Maybe UUID -- ^ 
  , connectorSyncEventProjectionCreatedAt :: UTCTime -- ^ 
  , connectorSyncEventProjectionConnectorId :: UUID -- ^ 
  , connectorSyncEventProjectionSyncCount :: Integer -- ^ 
  , connectorSyncEventProjectionSyncStatus :: Text -- ^ 
  } deriving (Show, Eq, Generic, Data)

instance FromJSON ConnectorSyncEventProjection where
  parseJSON = genericParseJSON (removeFieldLabelPrefix True "connectorSyncEventProjection")
instance ToJSON ConnectorSyncEventProjection where
  toJSON = genericToJSON (removeFieldLabelPrefix False "connectorSyncEventProjection")


-- | 
data ConnectorSyncRequestResult = ConnectorSyncRequestResult
  { connectorSyncRequestResultSyncResult :: Maybe ConnectorSyncResult -- ^ 
  , connectorSyncRequestResultException :: Maybe ConnectorSyncRequestResultException -- ^ 
...
-- | 
data ConnectorSyncRequestResultException = ConnectorSyncRequestResultException
  { connectorSyncRequestResultExceptionCause :: Maybe ConnectorSyncRequestResultExceptionCause -- ^ 
  , connectorSyncRequestResultExceptionStackTrace :: Maybe [ConnectorSyncRequestResultExceptionCauseStackTrace] -- ^ 
  , connectorSyncRequestResultExceptionMessage :: Maybe Text -- ^ 
  , connectorSyncRequestResultExceptionSuppressed :: Maybe [ConnectorSyncRequestResultExceptionCauseSuppressed] -- ^ 
  , connectorSyncRequestResultExceptionLocalizedMessage :: Maybe Text -- ^ 
  } deriving (Show, Eq, Generic, Data)

instance FromJSON ConnectorSyncRequestResultException where
  parseJSON = genericParseJSON (removeFieldLabelPrefix True "connectorSyncRequestResultException")
instance ToJSON ConnectorSyncRequestResultException where
  toJSON = genericToJSON (removeFieldLabelPrefix False "connectorSyncRequestResultException")


-- | 
data ConnectorSyncRequestResultExceptionCause = ConnectorSyncRequestResultExceptionCause
  { connectorSyncRequestResultExceptionCauseStackTrace :: Maybe [ConnectorSyncRequestResultExceptionCauseStackTrace] -- ^ 
  , connectorSyncRequestResultExceptionCauseMessage :: Maybe Text -- ^ 
  , connectorSyncRequestResultExceptionCauseSuppressed :: Maybe [ConnectorSyncRequestResultExceptionCauseSuppressed] -- ^ 
  , connectorSyncRequestResultExceptionCauseLocalizedMessage :: Maybe Text -- ^ 
  } deriving (Show, Eq, Generic, Data)

instance FromJSON ConnectorSyncRequestResultExceptionCause where
  parseJSON = genericParseJSON (removeFieldLabelPrefix True "connectorSyncRequestResultExceptionCause")
instance ToJSON ConnectorSyncRequestResultExceptionCause where
  toJSON = genericToJSON (removeFieldLabelPrefix False "connectorSyncRequestResultExceptionCause")


-- | 
data ConnectorSyncRequestResultExceptionCauseStackTrace = ConnectorSyncRequestResultExceptionCauseStackTrace
  { connectorSyncRequestResultExceptionCauseStackTraceClassLoaderName :: Maybe Text -- ^ 
  , connectorSyncRequestResultExceptionCauseStackTraceModuleName :: Maybe Text -- ^ 
  , connectorSyncRequestResultExceptionCauseStackTraceModuleVersion :: Maybe Text -- ^ 
  , connectorSyncRequestResultExceptionCauseStackTraceMethodName :: Maybe Text -- ^ 
  , connectorSyncRequestResultExceptionCauseStackTraceFileName :: Maybe Text -- ^ 
  , connectorSyncRequestResultExceptionCauseStackTraceLineNumber :: Maybe Int -- ^ 
  , connectorSyncRequestResultExceptionCauseStackTraceNativeMethod :: Maybe Bool -- ^ 
  , connectorSyncRequestResultExceptionCauseStackTraceClassName :: Maybe Text -- ^ 
  } deriving (Show, Eq, Generic, Data)

instance FromJSON ConnectorSyncRequestResultExceptionCauseStackTrace where
  parseJSON = genericParseJSON (removeFieldLabelPrefix True "connectorSyncRequestResultExceptionCauseStackTrace")
instance ToJSON ConnectorSyncRequestResultExceptionCauseStackTrace where
  toJSON = genericToJSON (removeFieldLabelPrefix False "connectorSyncRequestResultExceptionCauseStackTrace")


-- | 
data ConnectorSyncRequestResultExceptionCauseSuppressed = ConnectorSyncRequestResultExceptionCauseSuppressed
  { connectorSyncRequestResultExceptionCauseSuppressedStackTrace :: Maybe [ConnectorSyncRequestResultExceptionCauseStackTrace] -- ^ 
  , connectorSyncRequestResultExceptionCauseSuppressedMessage :: Maybe Text -- ^ 
  , connectorSyncRequestResultExceptionCauseSuppressedLocalizedMessage :: Maybe Text -- ^ 
  } deriving (Show, Eq, Generic, Data)

instance FromJSON ConnectorSyncRequestResultExceptionCauseSuppressed where
  parseJSON = genericParseJSON (removeFieldLabelPrefix True "connectorSyncRequestResultExceptionCauseSuppressed")
instance ToJSON ConnectorSyncRequestResultExceptionCauseSuppressed where
  toJSON = genericToJSON (removeFieldLabelPrefix False "connectorSyncRequestResultExceptionCauseSuppressed")


-- | 
data ConnectorSyncResult = ConnectorSyncResult
  { connectorSyncResultEmailSyncCount :: Integer -- ^ 
  , connectorSyncResultLogLines :: Maybe [Text] -- ^ 
  } deriving (Show, Eq, Generic, Data)
...
-- | 
data CreateConnectorImapOptions = CreateConnectorImapOptions
  { createConnectorImapOptionsHost :: Text -- ^ 
  , createConnectorImapOptionsPort :: Int -- ^ 
  , createConnectorImapOptionsUsername :: Text -- ^ 
  , createConnectorImapOptionsPassword :: Text -- ^ 
  , createConnectorImapOptionsUseSSL :: Bool -- ^ 
  } deriving (Show, Eq, Generic, Data)

instance FromJSON CreateConnectorImapOptions where
  parseJSON = genericParseJSON (removeFieldLabelPrefix True "createConnectorImapOptions")
instance ToJSON CreateConnectorImapOptions where
  toJSON = genericToJSON (removeFieldLabelPrefix False "createConnectorImapOptions")


-- | 
data CreateConnectorOptions = CreateConnectorOptions
  { createConnectorOptionsConnectorType :: Text -- ^ 
  , createConnectorOptionsConnectorAuthType :: Text -- ^ 
  , createConnectorOptionsImapSettings :: Maybe CreateConnectorImapOptions -- ^ 
  , createConnectorOptionsInboxId :: Maybe UUID -- ^ 
  , createConnectorOptionsSyncEnabled :: Bool -- ^ 
  , createConnectorOptionsSyncScheduleType :: Text -- ^ 
  , createConnectorOptionsSyncInterval :: Maybe Int -- ^ 
  } deriving (Show, Eq, Generic, Data)
...
data CreateInboxReplierOptions = CreateInboxReplierOptions
  { createInboxReplierOptionsInboxId :: UUID -- ^ Inbox ID to attach replier to
...
data PageConnector = PageConnector
  ...
  , pageConnectorTotal :: Maybe Integer -- ^ 
  , pageConnectorTotalElements :: Maybe Integer -- ^ 
  , pageConnectorTotalPages :: Maybe Int -- ^ 
  , pageConnectorLast :: Maybe Bool -- ^ 
  , pageConnectorSize :: Maybe Int -- ^ 
  , pageConnectorNumber :: Maybe Int -- ^ 
  , pageConnectorSort :: Maybe Sort -- ^ 
...
data PageConnectorSyncEvents = PageConnectorSyncEvents
  { pageConnectorSyncEventsContent :: Maybe [ConnectorSyncEventProjection] -- ^ 
  , pageConnectorSyncEventsPageable :: Maybe PageableObject -- ^ 
  , pageConnectorSyncEventsTotal :: Maybe Integer -- ^ 
  , pageConnectorSyncEventsTotalElements :: Maybe Integer -- ^ 
  , pageConnectorSyncEventsTotalPages :: Maybe Int -- ^ 
  , pageConnectorSyncEventsLast :: Maybe Bool -- ^ 
  , pageConnectorSyncEventsSize :: Maybe Int -- ^ 
  , pageConnectorSyncEventsNumber :: Maybe Int -- ^ 
  , pageConnectorSyncEventsSort :: Maybe Sort -- ^ 
  , pageConnectorSyncEventsNumberOfElements :: Maybe Int -- ^ 
  , pageConnectorSyncEventsFirst :: Maybe Bool -- ^ 
  , pageConnectorSyncEventsEmpty :: Maybe Bool -- ^ 
  } deriving (Show, Eq, Generic, Data)

instance FromJSON PageConnectorSyncEvents where
  parseJSON = genericParseJSON (removeFieldLabelPrefix True "pageConnectorSyncEvents")
instance ToJSON PageConnectorSyncEvents where
  toJSON = genericToJSON (removeFieldLabelPrefix False "pageConnectorSyncEvents")
...
data PageInboxForwarderEvents = PageInboxForwarderEvents
  ...
  , pageInboxForwarderEventsTotal :: Maybe Integer -- ^ 
  , pageInboxForwarderEventsTotalElements :: Maybe Integer -- ^ 
  , pageInboxForwarderEventsTotalPages :: Maybe Int -- ^ 
  , pageInboxForwarderEventsLast :: Maybe Bool -- ^ 
  , pageInboxForwarderEventsSize :: Maybe Int -- ^ 
  , pageInboxForwarderEventsNumber :: Maybe Int -- ^ 
  , pageInboxForwarderEventsSort :: Maybe Sort -- ^ 
...
data PageInboxReplierDto = PageInboxReplierDto
  ...
  , pageInboxReplierDtoTotal :: Maybe Integer -- ^ 
  , pageInboxReplierDtoTotalElements :: Maybe Integer -- ^ 
  , pageInboxReplierDtoTotalPages :: Maybe Int -- ^ 
  , pageInboxReplierDtoLast :: Maybe Bool -- ^ 
  , pageInboxReplierDtoSize :: Maybe Int -- ^ 
  , pageInboxReplierDtoNumber :: Maybe Int -- ^ 
  , pageInboxReplierDtoSort :: Maybe Sort -- ^ 
...
data PageInboxReplierEvents = PageInboxReplierEvents
  ...
  , pageInboxReplierEventsTotal :: Maybe Integer -- ^ 
  , pageInboxReplierEventsTotalElements :: Maybe Integer -- ^ 
  , pageInboxReplierEventsTotalPages :: Maybe Int -- ^ 
  , pageInboxReplierEventsLast :: Maybe Bool -- ^ 
  , pageInboxReplierEventsSize :: Maybe Int -- ^ 
  , pageInboxReplierEventsNumber :: Maybe Int -- ^ 
  , pageInboxReplierEventsSort :: Maybe Sort -- ^ 
...
data PageListUnsubscribeRecipients = PageListUnsubscribeRecipients
  ...
  , pageListUnsubscribeRecipientsTotal :: Maybe Integer -- ^ 
  , pageListUnsubscribeRecipientsTotalElements :: Maybe Integer -- ^ 
  , pageListUnsubscribeRecipientsTotalPages :: Maybe Int -- ^ 
  ...
  , pageListUnsubscribeRecipientsSort :: Maybe Sort -- ^ 
...
data PageScheduledJobs = PageScheduledJobs
  ...
  , pageScheduledJobsTotal :: Maybe Integer -- ^ 
  , pageScheduledJobsTotalElements :: Maybe Integer -- ^ 
  , pageScheduledJobsTotalPages :: Maybe Int -- ^ 
  , pageScheduledJobsLast :: Maybe Bool -- ^ 
  , pageScheduledJobsSize :: Maybe Int -- ^ 
  , pageScheduledJobsNumber :: Maybe Int -- ^ 
  , pageScheduledJobsSort :: Maybe Sort -- ^ 
...
data SentSmsDto = SentSmsDto
  ...
  , sentSmsDtoBody :: Text -- ^ 
  , sentSmsDtoSid :: Text -- ^ 
  , sentSmsDtoReplyToSid :: Text -- ^ 
  , sentSmsDtoReplyToId :: UUID -- ^ 
