...
data ConnectorDto = ConnectorDto
  ...
  , connectorDtoSyncScheduleType :: Maybe Text -- ^ 
  , connectorDtoSyncInterval :: Maybe Int -- ^ 
  , connectorDtoHasImapConnection :: Bool -- ^ 
  , connectorDtoHasSmtpConnection :: Bool -- ^ 
...
data ConnectorImapConnectionDto = ConnectorImapConnectionDto
  ...
  , connectorImapConnectionDtoImapHost :: Maybe Text -- ^ 
...
data ConnectorProjection = ConnectorProjection
  ...
  , connectorProjectionSyncEnabled :: Maybe Bool -- ^ 
...
data ConnectorSmtpConnectionDto = ConnectorSmtpConnectionDto
  ...
  , connectorSmtpConnectionDtoSmtpHost :: Maybe Text -- ^ 
...
data CreateConnectorOptions = CreateConnectorOptions
  { createConnectorOptionsSyncEnabled :: Maybe Bool -- ^ Enable automatic background sync
  , createConnectorOptionsSyncScheduleType :: Maybe Text -- ^ Sync schedule type
  , createConnectorOptionsSyncInterval :: Maybe Int -- ^ Sync interval in minutes
...
data ImapMailboxStatus = ImapMailboxStatus
  ...
  , imapMailboxStatusItems :: (Map.Map String Value) -- ^ The mailbox items that are currently filled in. This map's values should not be used directly, they must only be used by libraries implementing extensions of the IMAP protocol.
