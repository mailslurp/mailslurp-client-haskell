...
data AttachmentEntity = AttachmentEntity
  ...
  , attachmentEntityInboxId :: Maybe UUID -- ^ 
...
data PageConnectorSyncEvents = PageConnectorSyncEvents
  ...
  , pageConnectorSyncEventsTotalPages :: Int -- ^ 
  , pageConnectorSyncEventsTotalElements :: Integer -- ^ 
...
data PageThreadProjection = PageThreadProjection
  ...
  , pageThreadProjectionTotalPages :: Int -- ^ 
  , pageThreadProjectionTotalElements :: Integer -- ^ 
