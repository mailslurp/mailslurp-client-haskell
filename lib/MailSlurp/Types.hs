...
data ExtractAttachmentTextOptions = ExtractAttachmentTextOptions
  { extractAttachmentTextOptionsMethod :: Maybe Text -- ^ Method for extracting text from attachments. OCR/LLM methods are reserved for advanced extraction.
...
data ExtractAttachmentTextResult = ExtractAttachmentTextResult
  ...
  , extractAttachmentTextResultMethodUsed :: Maybe Text -- ^ Method for extracting text from attachments. OCR/LLM methods are reserved for advanced extraction.
