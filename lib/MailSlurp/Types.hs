...
data SendEmailOptions = SendEmailOptions
  ...
  , sendEmailOptionsHtml :: Maybe Bool -- ^ Optional HTML flag (Deprecated: use isHTML instead)
  ...
  , sendEmailOptionsUseInboxName :: Maybe Bool -- ^ Use name of inbox as sender email address name. Will construct RFC 5322 email address with `Inbox name <inbox@address.com>`
  } deriving (Show, Eq, Generic, Data)
