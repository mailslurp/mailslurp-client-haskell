...
-- | 
data AITranformCreateOptions = AITranformCreateOptions
  { aITranformCreateOptionsName :: Maybe Text -- ^ 
  , aITranformCreateOptionsConditions :: Maybe [Text] -- ^ 
  , aITranformCreateOptionsInstructions :: Maybe [Text] -- ^ 
  , aITranformCreateOptionsOutputSchema :: Maybe StructuredOutputSchema -- ^ 
  } deriving (Show, Eq, Generic, Data)

instance FromJSON AITranformCreateOptions where
  parseJSON = genericParseJSON (removeFieldLabelPrefix True "aITranformCreateOptions")
instance ToJSON AITranformCreateOptions where
  toJSON = genericToJSON (removeFieldLabelPrefix False "aITranformCreateOptions")
...
data AITransformMappingDto = AITransformMappingDto
  ...
  , aITransformMappingDtoEntityId :: UUID -- ^ 
...
data AITransformMappingProjection = AITransformMappingProjection
  ...
  , aITransformMappingProjectionEntityId :: UUID -- ^ 
...
data AITransformResultDto = AITransformResultDto
  ...
  , aITransformResultDtoAiTransformMappingId :: UUID -- ^ 
  , aITransformResultDtoValue :: Value -- ^ 
  , aITransformResultDtoEntityId :: UUID -- ^ 
  , aITransformResultDtoEntityType :: Text -- ^ 
...
-- | 
data AITransformResultProjection = AITransformResultProjection
  { aITransformResultProjectionUserId :: UUID -- ^ 
  , aITransformResultProjectionAiTransformId :: UUID -- ^ 
  , aITransformResultProjectionEntityId :: UUID -- ^ 
  , aITransformResultProjectionEntityType :: Text -- ^ 
  , aITransformResultProjectionAiTransformMappingId :: UUID -- ^ 
  , aITransformResultProjectionValue :: Maybe Text -- ^ 
  , aITransformResultProjectionId :: UUID -- ^ 
  } deriving (Show, Eq, Generic, Data)

instance FromJSON AITransformResultProjection where
  parseJSON = genericParseJSON (removeFieldLabelPrefix True "aITransformResultProjection")
instance ToJSON AITransformResultProjection where
  toJSON = genericToJSON (removeFieldLabelPrefix False "aITransformResultProjection")
...
data CreateAITransformerMappingOptions = CreateAITransformerMappingOptions
  { createAITransformerMappingOptionsName :: Text -- ^ 
  , createAITransformerMappingOptionsAiTransformId :: UUID -- ^ 
  , createAITransformerMappingOptionsEntityId :: UUID -- ^ 
...
data CreateTotpDeviceOtpAuthUrlOptions = CreateTotpDeviceOtpAuthUrlOptions
  { createTotpDeviceOtpAuthUrlOptionsOtpAuthUrl :: Text -- ^ 
  , createTotpDeviceOtpAuthUrlOptionsName :: Maybe Text -- ^ 
  , createTotpDeviceOtpAuthUrlOptionsUsername :: Maybe Text -- ^ 
  , createTotpDeviceOtpAuthUrlOptionsIssuer :: Maybe Text -- ^ 
  , createTotpDeviceOtpAuthUrlOptionsDigits :: Maybe Int -- ^ 
  , createTotpDeviceOtpAuthUrlOptionsPeriod :: Maybe Int -- ^ 
  , createTotpDeviceOtpAuthUrlOptionsAlgorithm :: Maybe Text -- ^ 
  } deriving (Show, Eq, Generic, Data)
...
data PageAITransformResultProjection = PageAITransformResultProjection
  { pageAITransformResultProjectionContent :: Maybe [AITransformResultProjection] -- ^ 
...
data StructuredOutputSchema = StructuredOutputSchema
  ...
  , structuredOutputSchemaEnum :: Maybe [Text] -- ^ When using type string and format enum pass a collection of enum values here.
