...
data InboxPreview = InboxPreview
  ...
  , inboxPreviewVirtualInbox :: Maybe Bool -- ^ Virtual inbox can receive email but will not send emails to real recipients. Will save sent email record but never send an actual email. Perfect for testing mail server actions.
...
data OrganizationInboxProjection = OrganizationInboxProjection
  ...
  , organizationInboxProjectionVirtualInbox :: Maybe Bool -- ^ Virtual inbox can receive email but will not send emails to real recipients. Will save sent email record but never send an actual email. Perfect for testing mail server actions.
  } deriving (Show, Eq, Generic, Data)
...
data SentEmailProjection = SentEmailProjection
  ...
  , sentEmailProjectionVirtualSend :: Maybe Bool -- ^ 
  } deriving (Show, Eq, Generic, Data)
