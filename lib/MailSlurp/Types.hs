...
data AbstractWebhookPayload = AbstractWebhookPayload
  { abstractWebhookPayloadEventName :: Maybe Text -- ^ 
  , abstractWebhookPayloadWebhookId :: Maybe UUID -- ^ 
  , abstractWebhookPayloadMessageId :: Maybe Text -- ^ 
...
data AliasProjection = AliasProjection
  ...
  , aliasProjectionId :: Maybe UUID -- ^ 
  , aliasProjectionUpdatedAt :: Maybe UTCTime -- ^ 
  , aliasProjectionUserId :: Maybe UUID -- ^ 
  , aliasProjectionEmailAddress :: Maybe Text -- ^ 
  , aliasProjectionInboxId :: Maybe UUID -- ^ 
  , aliasProjectionCreatedAt :: Maybe UTCTime -- ^ 
...
data AttachmentEntity = AttachmentEntity
  ...
  , attachmentEntityAttachmentId :: Maybe Text -- ^ 
  , attachmentEntityUserId :: Maybe UUID -- ^ 
  , attachmentEntityContentType :: Maybe Text -- ^ 
  , attachmentEntityContentLength :: Maybe Integer -- ^ 
  , attachmentEntityName :: Maybe Text -- ^ 
  , attachmentEntityCreatedAt :: Maybe UTCTime -- ^ 
  , attachmentEntityUpdatedAt :: Maybe UTCTime -- ^ 
  } deriving (Show, Eq, Generic, Data)
...
data AttachmentProjection = AttachmentProjection
  ...
  , attachmentProjectionUpdatedAt :: Maybe UTCTime -- ^ 
  , attachmentProjectionUserId :: Maybe UUID -- ^ 
  , attachmentProjectionAttachmentId :: Maybe Text -- ^ Attachment ID
  , attachmentProjectionCreatedAt :: Maybe UTCTime -- ^ 
...
data BasicAuthOptions = BasicAuthOptions
  { basicAuthOptionsUsername :: Maybe Text -- ^ 
  , basicAuthOptionsPassword :: Maybe Text -- ^ 
  } deriving (Show, Eq, Generic, Data)
...
data BounceProjection = BounceProjection
  ...
  , bounceProjectionSender :: Maybe Text -- ^ 
  , bounceProjectionCreatedAt :: Maybe UTCTime -- ^ 
  } deriving (Show, Eq, Generic, Data)
...
data BounceRecipient = BounceRecipient
  ...
  , bounceRecipientUserId :: Maybe UUID -- ^ 
  , bounceRecipientRecipient :: Maybe Text -- ^ 
  , bounceRecipientCreatedAt :: Maybe UTCTime -- ^ 
  , bounceRecipientUpdatedAt :: Maybe UTCTime -- ^ 
  } deriving (Show, Eq, Generic, Data)
...
data BouncedEmailDto = BouncedEmailDto
  ...
  , bouncedEmailDtoUserId :: Maybe UUID -- ^ 
  , bouncedEmailDtoNotificationType :: Maybe Text -- ^ 
  , bouncedEmailDtoSentToRecipients :: Maybe [Text] -- ^ 
  , bouncedEmailDtoSender :: Maybe Text -- ^ 
  ...
  , bouncedEmailDtoCreatedAt :: Maybe UTCTime -- ^ 
  } deriving (Show, Eq, Generic, Data)
...
data BouncedRecipientDto = BouncedRecipientDto
  ...
  , bouncedRecipientDtoRecipient :: Maybe Text -- ^ 
  , bouncedRecipientDtoCreatedAt :: Maybe UTCTime -- ^ 
  } deriving (Show, Eq, Generic, Data)
...
data ConditionOption = ConditionOption
  { conditionOptionCondition :: Maybe Text -- ^ Condition of an email object that can be used to filter results
  , conditionOptionValue :: Maybe Text -- ^ Expected condition value
  } deriving (Show, Eq, Generic, Data)
...
data ContactProjection = ContactProjection
  { contactProjectionId :: Maybe UUID -- ^ 
  ...
  , contactProjectionCreatedAt :: Maybe UTCTime -- ^ 
  } deriving (Show, Eq, Generic, Data)
...
data CountDto = CountDto
  { countDtoTotalElements :: Maybe Integer -- ^ 
  } deriving (Show, Eq, Generic, Data)
...
data CreateGroupOptions = CreateGroupOptions
  { createGroupOptionsName :: Maybe Text -- ^ 
...
data CreateInboxForwarderOptions = CreateInboxForwarderOptions
  ...
  , createInboxForwarderOptionsForwardToRecipients :: Maybe [Text] -- ^ Email addresses to forward an email to if it matches the field and match criteria of the forwarder
  } deriving (Show, Eq, Generic, Data)
...
data CreateTemplateOptions = CreateTemplateOptions
  { createTemplateOptionsName :: Maybe Text -- ^ 
  , createTemplateOptionsContent :: Maybe Text -- ^ 
  } deriving (Show, Eq, Generic, Data)
...
data DNSLookupResult = DNSLookupResult
  { dNSLookupResultRecordType :: Maybe Text -- ^ Domain Name Server Record Types
  , dNSLookupResultTtl :: Maybe Integer -- ^ 
  , dNSLookupResultRecordEntries :: Maybe [Text] -- ^ 
  , dNSLookupResultName :: Maybe Text -- ^ 
  } deriving (Show, Eq, Generic, Data)
...
data DNSLookupResults = DNSLookupResults
  { dNSLookupResultsResults :: Maybe [DNSLookupResult] -- ^ 
  } deriving (Show, Eq, Generic, Data)
...
data DescribeMailServerDomainResult = DescribeMailServerDomainResult
  { describeMailServerDomainResultMxRecords :: Maybe [NameServerRecord] -- ^ 
  , describeMailServerDomainResultDomain :: Maybe Text -- ^ 
...
data DomainDto = DomainDto
  { domainDtoId :: Maybe UUID -- ^ 
  , domainDtoUserId :: Maybe UUID -- ^ 
  ...
  , domainDtoCreatedAt :: Maybe UTCTime -- ^ 
  , domainDtoUpdatedAt :: Maybe UTCTime -- ^ 
  , domainDtoDomainType :: Maybe Text -- ^ Type of domain. Dictates type of inbox that can be created with domain. HTTP means inboxes are processed using SES while SMTP inboxes use a custom SMTP mail server. SMTP does not support sending so use HTTP for sending emails.
  , domainDtoVerified :: Maybe Bool -- ^ 
  } deriving (Show, Eq, Generic, Data)
...
data DomainNameRecord = DomainNameRecord
  { domainNameRecordRecordType :: Maybe Text -- ^ Domain Name Server Record Types
  , domainNameRecordName :: Maybe Text -- ^ 
  , domainNameRecordRecordEntries :: Maybe [Text] -- ^ 
  , domainNameRecordTtl :: Maybe Integer -- ^ 
  } deriving (Show, Eq, Generic, Data)
...
data DomainPreview = DomainPreview
  { domainPreviewId :: Maybe UUID -- ^ 
  , domainPreviewDomain :: Maybe Text -- ^ 
  , domainPreviewCatchAllInboxId :: Maybe UUID -- ^ 
  , domainPreviewCreatedAt :: Maybe UTCTime -- ^ 
  , domainPreviewDomainType :: Maybe Text -- ^ Type of domain. Dictates type of inbox that can be created with domain. HTTP means inboxes are processed using SES while SMTP inboxes use a custom SMTP mail server. SMTP does not support sending so use HTTP for sending emails.
  , domainPreviewVerified :: Maybe Bool -- ^ 
  } deriving (Show, Eq, Generic, Data)
...
data Email = Email
  ...
  , emailTo :: Maybe [Text] -- ^ List of `To` recipient email addresses that the email was addressed to. See recipients object for names.
  ...
  , emailRead :: Maybe Bool -- ^ Read flag. Has the email ever been viewed in the dashboard or fetched via the API with a hydrated body? If so the email is marked as read. Paginated results do not affect read status. Read status is different to email opened event as it depends on your own account accessing the email. Email opened is determined by tracking pixels sent to other uses if enable during sending. You can listened for both email read and email opened events using webhooks.
...
data EmailContentMatchResult = EmailContentMatchResult
  { emailContentMatchResultPattern :: Maybe Text -- ^ 
  , emailContentMatchResultMatches :: Maybe [Text] -- ^ 
  } deriving (Show, Eq, Generic, Data)
...
data EmailLinksResult = EmailLinksResult
  { emailLinksResultLinks :: Maybe [Text] -- ^ 
  , emailLinksResultBody :: Maybe Text -- ^ 
  } deriving (Show, Eq, Generic, Data)
...
data EmailPreview = EmailPreview
  ...
  , emailPreviewTo :: Maybe [Text] -- ^ List of `To` recipient email addresses that the email was addressed to. See recipients object for names.
...
data EmailProjection = EmailProjection
  ...
  , emailProjectionInboxId :: Maybe UUID -- ^ 
  , emailProjectionTo :: Maybe [Text] -- ^ 
  , emailProjectionAttachments :: Maybe [Text] -- ^ 
  , emailProjectionBcc :: Maybe [Text] -- ^ 
  , emailProjectionCc :: Maybe [Text] -- ^ 
  , emailProjectionCreatedAt :: Maybe UTCTime -- ^ 
  } deriving (Show, Eq, Generic, Data)
...
data EmailTextLinesResult = EmailTextLinesResult
  { emailTextLinesResultLines :: Maybe [Text] -- ^ 
  , emailTextLinesResultBody :: Maybe Text -- ^ 
  } deriving (Show, Eq, Generic, Data)
...
data EmailVerificationResult = EmailVerificationResult
  { emailVerificationResultDomainName :: Maybe Text -- ^ 
  , emailVerificationResultPort :: Maybe Int -- ^ 
  , emailVerificationResultEmailAddress :: Maybe Text -- ^ 
  , emailVerificationResultError :: Maybe Text -- ^ 
  , emailVerificationResultValid :: Maybe Bool -- ^ 
  } deriving (Show, Eq, Generic, Data)
...
data ExpirationDefaults = ExpirationDefaults
  ...
  , expirationDefaultsCanPermanentInbox :: Maybe Bool -- ^ 
  , expirationDefaultsNextInboxAllowsPermanent :: Maybe Bool -- ^ 
  } deriving (Show, Eq, Generic, Data)
...
data ExpiredInboxDto = ExpiredInboxDto
  { expiredInboxDtoId :: Maybe UUID -- ^ 
  , expiredInboxDtoInboxId :: Maybe UUID -- ^ 
  , expiredInboxDtoEmailAddress :: Maybe Text -- ^ 
  } deriving (Show, Eq, Generic, Data)
...
data ExpiredInboxRecordProjection = ExpiredInboxRecordProjection
  { expiredInboxRecordProjectionId :: Maybe UUID -- ^ 
  , expiredInboxRecordProjectionUserId :: Maybe UUID -- ^ 
  , expiredInboxRecordProjectionEmailAddress :: Maybe Text -- ^ 
  , expiredInboxRecordProjectionCreatedAt :: Maybe UTCTime -- ^ 
  } deriving (Show, Eq, Generic, Data)
...
data ExportLink = ExportLink
  { exportLinkDownloadLink :: Maybe Text -- ^ 
  } deriving (Show, Eq, Generic, Data)
...
data ExportOptions = ExportOptions
  { exportOptionsOutputFormat :: Maybe Text -- ^ 
...
data FlushExpiredInboxesResult = FlushExpiredInboxesResult
  { flushExpiredInboxesResultInboxIds :: Maybe [UUID] -- ^ 
  , flushExpiredInboxesResultExpireBefore :: Maybe UTCTime -- ^ 
  } deriving (Show, Eq, Generic, Data)
...
data GravatarUrl = GravatarUrl
  { gravatarUrlUrl :: Maybe Text -- ^ 
  , gravatarUrlHash :: Maybe Text -- ^ 
  } deriving (Show, Eq, Generic, Data)
...
data GroupContactsDto = GroupContactsDto
  { groupContactsDtoGroup :: Maybe GroupDto -- ^ 
  , groupContactsDtoContacts :: Maybe [ContactDto] -- ^ 
  } deriving (Show, Eq, Generic, Data)
...
data GroupDto = GroupDto
  { groupDtoId :: Maybe UUID -- ^ 
  , groupDtoName :: Maybe Text -- ^ 
  , groupDtoDescription :: Maybe Text -- ^ 
  , groupDtoCreatedAt :: Maybe UTCTime -- ^ 
  } deriving (Show, Eq, Generic, Data)
...
data GroupProjection = GroupProjection
  { groupProjectionName :: Maybe Text -- ^ 
  , groupProjectionId :: Maybe UUID -- ^ 
  , groupProjectionDescription :: Maybe Text -- ^ 
  , groupProjectionCreatedAt :: Maybe UTCTime -- ^ 
  } deriving (Show, Eq, Generic, Data)
...
data HTMLValidationResult = HTMLValidationResult
  ...
  , hTMLValidationResultValid :: Maybe Bool -- ^ 
  } deriving (Show, Eq, Generic, Data)
...
data IPAddressResult = IPAddressResult
  { iPAddressResultAddress :: Maybe Text -- ^ 
  , iPAddressResultHostname :: Maybe Text -- ^ 
  } deriving (Show, Eq, Generic, Data)
...
data InboxDto = InboxDto
  ...
  , inboxDtoCreatedAt :: Maybe UTCTime -- ^ When the inbox was created. Time stamps are in ISO DateTime Format `yyyy-MM-dd'T'HH:mm:ss.SSSXXX` e.g. `2000-10-31T01:30:00.000-05:00`.
  ...
  , inboxDtoReadOnly :: Maybe Bool -- ^ Is the inbox readOnly for the caller. Read only means can not be deleted or modified. This flag is present when using team accounts and shared inboxes.
  } deriving (Show, Eq, Generic, Data)
...
data InboxExistsDto = InboxExistsDto
  { inboxExistsDtoExists :: Maybe Bool -- ^ 
  } deriving (Show, Eq, Generic, Data)
...
data InboxForwarderDto = InboxForwarderDto
  { inboxForwarderDtoId :: Maybe UUID -- ^ 
  , inboxForwarderDtoInboxId :: Maybe UUID -- ^ 
  , inboxForwarderDtoField :: Maybe Text -- ^ 
  , inboxForwarderDtoMatch :: Maybe Text -- ^ 
  , inboxForwarderDtoForwardToRecipients :: Maybe [Text] -- ^ 
  , inboxForwarderDtoCreatedAt :: Maybe UTCTime -- ^ 
  } deriving (Show, Eq, Generic, Data)
...
data InboxForwarderTestOptions = InboxForwarderTestOptions
  { inboxForwarderTestOptionsTestValue :: Maybe Text -- ^ 
  } deriving (Show, Eq, Generic, Data)
...
data InboxForwarderTestResult = InboxForwarderTestResult
  { inboxForwarderTestResultMatches :: Maybe (Map.Map String Bool) -- ^ 
  , inboxForwarderTestResultDoesMatch :: Maybe Bool -- ^ 
  } deriving (Show, Eq, Generic, Data)
...
data InboxPreview = InboxPreview
  { inboxPreviewId :: Maybe UUID -- ^ ID of the inbox. The ID is a UUID-V4 format string. Use the inboxId for calls to Inbox and Email Controller endpoints. See the emailAddress property for the email address or the inbox. To get emails in an inbox use the WaitFor and Inbox Controller methods `waitForLatestEmail` and `getEmails` methods respectively. Inboxes can be used with aliases to forward emails automatically.
  , inboxPreviewEmailAddress :: Maybe Text -- ^ The inbox's email address. Inbox projections and previews may not include the email address. To view the email address fetch the inbox entity directly. Send an email to this address and the inbox will receive and store it for you. Note the email address in MailSlurp match characters exactly and are case sensitive so `+123` additions are considered different addresses. To retrieve the email use the Inbox and Email Controller endpoints with the inbox ID.
  , inboxPreviewCreatedAt :: Maybe UTCTime -- ^ When the inbox was created. Time stamps are in ISO DateTime Format `yyyy-MM-dd'T'HH:mm:ss.SSSXXX` e.g. `2000-10-31T01:30:00.000-05:00`.
  , inboxPreviewFavourite :: Maybe Bool -- ^ Is the inbox a favorite inbox. Make an inbox a favorite is typically done in the dashboard for quick access or filtering
  ...
  , inboxPreviewTeamAccess :: Maybe Bool -- ^ Does inbox permit team access for organization team members. If so team users can use inbox and emails associated with it. See the team access guide at https://www.mailslurp.com/guides/team-email-account-sharing/
...
data InboxRulesetDto = InboxRulesetDto
  { inboxRulesetDtoId :: Maybe UUID -- ^ 
  , inboxRulesetDtoInboxId :: Maybe UUID -- ^ 
  , inboxRulesetDtoScope :: Maybe Text -- ^ 
  , inboxRulesetDtoAction :: Maybe Text -- ^ 
  , inboxRulesetDtoTarget :: Maybe Text -- ^ 
  , inboxRulesetDtoHandler :: Maybe Text -- ^ 
  , inboxRulesetDtoCreatedAt :: Maybe UTCTime -- ^ 
  } deriving (Show, Eq, Generic, Data)
...
data InboxRulesetTestOptions = InboxRulesetTestOptions
  { inboxRulesetTestOptionsTestTarget :: Maybe Text -- ^ 
  } deriving (Show, Eq, Generic, Data)
...
data InboxRulesetTestResult = InboxRulesetTestResult
  ...
  , inboxRulesetTestResultMatches :: Maybe Bool -- ^ 
  } deriving (Show, Eq, Generic, Data)
...
data MatchOption = MatchOption
  { matchOptionField :: Maybe Text -- ^ Fields of an email object that can be used to filter results
  , matchOptionShould :: Maybe Text -- ^ How the value of the email field specified should be compared to the value given in the match options.
...
data MissedEmail = MissedEmail
  ...
  , missedEmailAttachmentCount :: Maybe Int -- ^ 
  , missedEmailFrom :: Maybe Text -- ^ 
  , missedEmailTo :: Maybe [Text] -- ^ 
  , missedEmailCc :: Maybe [Text] -- ^ 
  , missedEmailBcc :: Maybe [Text] -- ^ 
  , missedEmailInboxIds :: Maybe [UUID] -- ^ 
  , missedEmailCreatedAt :: Maybe UTCTime -- ^ 
  , missedEmailUpdatedAt :: Maybe UTCTime -- ^ 
  } deriving (Show, Eq, Generic, Data)
...
data NameServerRecord = NameServerRecord
  { nameServerRecordRaw :: Maybe Text -- ^ 
  , nameServerRecordRecordType :: Maybe Text -- ^ 
  , nameServerRecordPriority :: Maybe Text -- ^ 
  , nameServerRecordValue :: Maybe Text -- ^ 
  } deriving (Show, Eq, Generic, Data)
...
data PageBouncedEmail = PageBouncedEmail
  ...
  , pageBouncedEmailPageable :: Maybe Pageable -- ^ 
...
data PageBouncedRecipients = PageBouncedRecipients
  ...
  , pageBouncedRecipientsPageable :: Maybe Pageable -- ^ 
...
data PageUnknownMissedEmailProjection = PageUnknownMissedEmailProjection
  ...
  , pageUnknownMissedEmailProjectionPageable :: Maybe Pageable -- ^ 
...
data RawEmailJson = RawEmailJson
  { rawEmailJsonContent :: Maybe Text -- ^ 
  } deriving (Show, Eq, Generic, Data)
...
data Recipient = Recipient
  { recipientRawValue :: Maybe Text -- ^ 
  , recipientEmailAddress :: Maybe Text -- ^ 
...
data SentEmailDto = SentEmailDto
  ...
  , sentEmailDtoSentAt :: Maybe UTCTime -- ^ 
...
data SentEmailProjection = SentEmailProjection
  ...
  , sentEmailProjectionCreatedAt :: Maybe UTCTime -- ^ 
  } deriving (Show, Eq, Generic, Data)
...
data TemplateDto = TemplateDto
  { templateDtoId :: Maybe UUID -- ^ 
  , templateDtoName :: Maybe Text -- ^ 
  , templateDtoVariables :: Maybe [TemplateVariable] -- ^ 
  , templateDtoContent :: Maybe Text -- ^ 
  , templateDtoCreatedAt :: Maybe UTCTime -- ^ 
  } deriving (Show, Eq, Generic, Data)
...
data TemplateProjection = TemplateProjection
  { templateProjectionName :: Maybe Text -- ^ 
  , templateProjectionId :: Maybe UUID -- ^ 
  , templateProjectionUpdatedAt :: Maybe UTCTime -- ^ 
  , templateProjectionCreatedAt :: Maybe UTCTime -- ^ 
  , templateProjectionVariables :: Maybe [Text] -- ^ 
  } deriving (Show, Eq, Generic, Data)
...
data TemplateVariable = TemplateVariable
  { templateVariableName :: Maybe Text -- ^ 
  , templateVariableVariableType :: Maybe Text -- ^ 
  } deriving (Show, Eq, Generic, Data)
...
data TestNewInboxForwarderOptions = TestNewInboxForwarderOptions
  { testNewInboxForwarderOptionsInboxForwarderTestOptions :: Maybe InboxForwarderTestOptions -- ^ 
  , testNewInboxForwarderOptionsCreateInboxForwarderOptions :: Maybe CreateInboxForwarderOptions -- ^ 
  } deriving (Show, Eq, Generic, Data)
...
data TestNewInboxRulesetOptions = TestNewInboxRulesetOptions
  { testNewInboxRulesetOptionsInboxRulesetTestOptions :: Maybe InboxRulesetTestOptions -- ^ 
  , testNewInboxRulesetOptionsCreateInboxRulesetOptions :: Maybe CreateInboxRulesetOptions -- ^ 
  } deriving (Show, Eq, Generic, Data)
...
data ThreadProjection = ThreadProjection
  ...
  , threadProjectionId :: Maybe UUID -- ^ 
  , threadProjectionUpdatedAt :: Maybe UTCTime -- ^ 
  , threadProjectionSubject :: Maybe Text -- ^ 
  , threadProjectionUserId :: Maybe UUID -- ^ 
  , threadProjectionInboxId :: Maybe UUID -- ^ 
  , threadProjectionTo :: Maybe [Text] -- ^ 
  , threadProjectionBcc :: Maybe [Text] -- ^ 
  , threadProjectionCc :: Maybe [Text] -- ^ 
  , threadProjectionCreatedAt :: Maybe UTCTime -- ^ 
  , threadProjectionAliasId :: Maybe UUID -- ^ 
  } deriving (Show, Eq, Generic, Data)
...
data TrackingPixelDto = TrackingPixelDto
  { trackingPixelDtoId :: Maybe UUID -- ^ 
  , trackingPixelDtoSeen :: Maybe Bool -- ^ 
  , trackingPixelDtoRecipient :: Maybe Text -- ^ 
  , trackingPixelDtoHtml :: Maybe Text -- ^ 
  , trackingPixelDtoUrl :: Maybe Text -- ^ 
  , trackingPixelDtoInboxId :: Maybe UUID -- ^ 
  , trackingPixelDtoSentEmailId :: Maybe UUID -- ^ 
  , trackingPixelDtoSeenAt :: Maybe UTCTime -- ^ 
  , trackingPixelDtoCreatedAt :: Maybe UTCTime -- ^ 
  } deriving (Show, Eq, Generic, Data)
...
data TrackingPixelProjection = TrackingPixelProjection
  ...
  , trackingPixelProjectionId :: Maybe UUID -- ^ 
  , trackingPixelProjectionUserId :: Maybe UUID -- ^ 
  , trackingPixelProjectionInboxId :: Maybe UUID -- ^ 
  , trackingPixelProjectionCreatedAt :: Maybe UTCTime -- ^ 
  , trackingPixelProjectionSeen :: Maybe Bool -- ^ 
...
data UnknownMissedEmailProjection = UnknownMissedEmailProjection
  { unknownMissedEmailProjectionId :: Maybe UUID -- ^ 
  ...
  , unknownMissedEmailProjectionCreatedAt :: Maybe UTCTime -- ^ 
  } deriving (Show, Eq, Generic, Data)
...
data UnreadCount = UnreadCount
  { unreadCountCount :: Maybe Integer -- ^ 
  } deriving (Show, Eq, Generic, Data)
...
data UnseenErrorCountDto = UnseenErrorCountDto
  { unseenErrorCountDtoCount :: Maybe Integer -- ^ 
  } deriving (Show, Eq, Generic, Data)
...
data UpdateGroupContacts = UpdateGroupContacts
  { updateGroupContactsContactIds :: Maybe [UUID] -- ^ 
  } deriving (Show, Eq, Generic, Data)
...
data ValidationMessage = ValidationMessage
  { validationMessageLineNumber :: Maybe Int -- ^ 
...
data VerifyEmailAddressOptions = VerifyEmailAddressOptions
  ...
  , verifyEmailAddressOptionsEmailAddress :: Maybe Text -- ^ 
...
data WaitForConditions = WaitForConditions
  { waitForConditionsInboxId :: Maybe UUID -- ^ 
  ...
  , waitForConditionsMatches :: Maybe [MatchOption] -- ^ 
  , waitForConditionsSortDirection :: Maybe Text -- ^ 
  , waitForConditionsSince :: Maybe UTCTime -- ^ 
  , waitForConditionsBefore :: Maybe UTCTime -- ^ 
  } deriving (Show, Eq, Generic, Data)
...
data WebhookDto = WebhookDto
  ...
  , webhookDtoPayloadJsonSchema :: Maybe Text -- ^ Deprecated. Fetch JSON Schema for webhook using the getJsonSchemaForWebhookPayload method
  , webhookDtoCreatedAt :: Maybe UTCTime -- ^ When the webhook was created
  , webhookDtoUpdatedAt :: Maybe UTCTime -- ^ 
...
data WebhookEmailReadPayload = WebhookEmailReadPayload
  { webhookEmailReadPayloadMessageId :: Maybe Text -- ^ Idempotent message ID. Store this ID locally or in a database to prevent message duplication.
  , webhookEmailReadPayloadWebhookId :: Maybe UUID -- ^ ID of webhook entity being triggered
  , webhookEmailReadPayloadEventName :: Maybe Text -- ^ Name of the event type webhook is being triggered for.
  , webhookEmailReadPayloadWebhookName :: Maybe Text -- ^ Name of the webhook being triggered
  , webhookEmailReadPayloadEmailId :: Maybe UUID -- ^ ID of the email that was received. Use this ID for fetching the email with the `EmailController`.
  , webhookEmailReadPayloadInboxId :: Maybe UUID -- ^ Id of the inbox that received an email
  , webhookEmailReadPayloadEmailIsRead :: Maybe Bool -- ^ Is the email read
  , webhookEmailReadPayloadCreatedAt :: Maybe UTCTime -- ^ Date time of event creation
  } deriving (Show, Eq, Generic, Data)
...
data WebhookNewContactPayload = WebhookNewContactPayload
  ...
  , webhookNewContactPayloadContactId :: Maybe UUID -- ^ 
  ...
  , webhookNewContactPayloadEmailAddresses :: Maybe [Text] -- ^ 
  , webhookNewContactPayloadTags :: Maybe [Text] -- ^ 
  , webhookNewContactPayloadMetaData :: Maybe Value -- ^ 
  , webhookNewContactPayloadOptOut :: Maybe Bool -- ^ 
  , webhookNewContactPayloadCreatedAt :: Maybe UTCTime -- ^ 
  } deriving (Show, Eq, Generic, Data)
...
data WebhookNewEmailPayload = WebhookNewEmailPayload
  ...
  , webhookNewEmailPayloadTo :: Maybe [Text] -- ^ List of `To` recipient email addresses that the email was addressed to. See recipients object for names.
  , webhookNewEmailPayloadFrom :: Maybe Text -- ^ Who the email was sent from. An email address - see fromName for the sender name.
  , webhookNewEmailPayloadCc :: Maybe [Text] -- ^ List of `CC` recipients email addresses that the email was addressed to. See recipients object for names.
  , webhookNewEmailPayloadBcc :: Maybe [Text] -- ^ List of `BCC` recipients email addresses that the email was addressed to. See recipients object for names.
...
data WebhookProjection = WebhookProjection
  ...
  , webhookProjectionId :: Maybe UUID -- ^ 
  , webhookProjectionUpdatedAt :: Maybe UTCTime -- ^ 
  , webhookProjectionUrl :: Maybe Text -- ^ 
  , webhookProjectionInboxId :: Maybe UUID -- ^ 
  , webhookProjectionEventName :: Maybe Text -- ^ 
  , webhookProjectionCreatedAt :: Maybe UTCTime -- ^ 
  } deriving (Show, Eq, Generic, Data)
...
data WebhookRedriveResult = WebhookRedriveResult
  { webhookRedriveResultWebhookResultId :: Maybe UUID -- ^ 
  , webhookRedriveResultSuccess :: Maybe Bool -- ^ 
...
data WebhookResultDto = WebhookResultDto
  ...
  , webhookResultDtoUserId :: Maybe UUID -- ^ 
  , webhookResultDtoInboxId :: Maybe UUID -- ^ 
  , webhookResultDtoWebhookId :: Maybe UUID -- ^ 
  , webhookResultDtoWebhookUrl :: Maybe Text -- ^ 
  , webhookResultDtoMessageId :: Maybe Text -- ^ 
  , webhookResultDtoRedriveId :: Maybe UUID -- ^ 
  , webhookResultDtoHttpMethod :: Maybe Text -- ^ 
  , webhookResultDtoWebhookEvent :: Maybe Text -- ^ 
  , webhookResultDtoResponseStatus :: Maybe Int -- ^ 
  , webhookResultDtoResponseTimeMillis :: Maybe Integer -- ^ 
  , webhookResultDtoResponseBodyExtract :: Maybe Text -- ^ 
  , webhookResultDtoResultType :: Maybe Text -- ^ 
  , webhookResultDtoCreatedAt :: Maybe UTCTime -- ^ 
  , webhookResultDtoUpdatedAt :: Maybe UTCTime -- ^ 
...
data WebhookTestRequest = WebhookTestRequest
  { webhookTestRequestUrl :: Maybe Text -- ^ 
  , webhookTestRequestMethod :: Maybe Text -- ^ 
  , webhookTestRequestHeaders :: Maybe (Map.Map String Text) -- ^ 
...
data WebhookTestResult = WebhookTestResult
  ...
  , webhookTestResultResponse :: Maybe WebhookTestResponse -- ^ 
  , webhookTestResultRequest :: Maybe WebhookTestRequest -- ^ 
  } deriving (Show, Eq, Generic, Data)
