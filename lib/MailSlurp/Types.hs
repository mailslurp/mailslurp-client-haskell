...
data AttachmentEntity = AttachmentEntity
  ...
  , attachmentEntityContentId :: Maybe Text -- ^ 
...
data ConnectorDto = ConnectorDto
  ...
  , connectorDtoSelectFolder :: Maybe Text -- ^ 
  , connectorDtoSearchTerms :: Maybe Text -- ^ 
...
data ConnectorSyncRequestResultException = ConnectorSyncRequestResultException
  ...
  , connectorSyncRequestResultExceptionSuppressed :: Maybe [ConnectorSyncRequestResultExceptionCause] -- ^ 
...
-- | 
data CreateConnectorImapFetchOptions = CreateConnectorImapFetchOptions
  { createConnectorImapFetchOptionsSelectFolder :: Maybe Text -- ^ 
  , createConnectorImapFetchOptionsSearchTerms :: Maybe Text -- ^ 
  } deriving (Show, Eq, Generic, Data)

instance FromJSON CreateConnectorImapFetchOptions where
  parseJSON = genericParseJSON (removeFieldLabelPrefix True "createConnectorImapFetchOptions")
instance ToJSON CreateConnectorImapFetchOptions where
  toJSON = genericToJSON (removeFieldLabelPrefix False "createConnectorImapFetchOptions")
...
data CreateConnectorOptions = CreateConnectorOptions
  ...
  , createConnectorOptionsFetchSettings :: Maybe CreateConnectorImapFetchOptions -- ^ 
  } deriving (Show, Eq, Generic, Data)
...
data PageConnectorSyncEvents = PageConnectorSyncEvents
  ...
  , pageConnectorSyncEventsSort :: Maybe SortObject -- ^ 
...
data PageThreadProjection = PageThreadProjection
  ...
  , pageThreadProjectionSort :: Maybe SortObject -- ^ 
